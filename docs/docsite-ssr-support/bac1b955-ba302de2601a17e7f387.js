"use strict";
(self.webpackChunksite = self.webpackChunksite || []).push([[1955], {
  96272: function (t, e, i) {
    i.d(e, {
      vs: function () {
        return ki
      }
    });
    var r = i(43696), s = i.n(r), n = i(26449), a = {
      ...
      p = {5: o, 6: o + " const class extends export import super"}, h = /^in(stanceof)?$/,
      c = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࢠ-ࢴࢶ-ࢽऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೞೠೡೱೲഅ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄງຈຊຍດ-ທນ-ຟມ-ຣລວສຫອ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜌᜎ-ᜑᜠ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭋᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲈᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳱᳵᳶᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-Ⱞⰰ-ⱞⱠ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆺㇰ-ㇿ㐀-䶵一-鿯ꀀ-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꞹꟷ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭥꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ",
      ...
      u = new RegExp("[" + c + "]"), d = new RegExp("[" + c + l + "]");
    c = l = null;
    ...
    function g(t, e) {
      return t < 65 ? 36 === t : t < 91 || (t < 97 ? 95 === t : t < 123 || (t <= 65535 ? t >= 170 && u.test(String.fromCharCode(t)) : !1 !== e && y(t, f)))
    }

    function v(t, e) {
      return t < 48 ? 36 === t : t < 58 || !(t < 65) && (t < 91 || (t < 97 ? 95 === t : t < 123 || (t <= 65535 ? t >= 170 && d.test(String.fromCharCode(t)) : !1 !== e && (y(t, f) || y(t, m)))))
    }
    ...
    var _ = {beforeExpr: !0}, k = {startsExpr: !0}, S = {};
    ...
    var E = {
      ...
      relational: b("</>/<=/>=", 7),
      bitShift: b("<</>>/>>>", 8),
      plusMin: new x("+/-", {beforeExpr: !0, binop: 9, prefix: !0, startsExpr: !0}),
      modulo: b("%", 10),
      star: b("*", 10),
      slash: b("/", 10),
    ...
    var L = /[\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff]/, P = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g,
      N = Object.prototype, T = N.hasOwnProperty, R = N.toString;
    ...
    function F(t, e) {
      for (var i = 1, r = 0; ;) {
        C.lastIndex = r;
        var s = C.exec(t);
        if (!(s && s.index < e)) return new V(i, e - r);
    ...
    function M(t) {
      ...
      if (e.ecmaVersion >= 2015 && (e.ecmaVersion -= 2009), null == e.allowReserved && (e.allowReserved = e.ecmaVersion < 5), j(e.onToken)) {
        var r = e.onToken;
        e.onToken = function (t) {
          return r.push(t)
        }
      }
      return j(e.onComment) && (e.onComment = function (t, e) {
        return function (i, r, s, n, a, o) {
          var p = {type: i ? "Block" : "Line", value: r, start: s, end: n};
          t.locations && (p.loc = new D(this, a, o)), t.ranges && (p.range = [s, n]), e.push(p)
        }
      }(e, e.onComment)), e
    }
    ...
    W.strictDirective = function (t) {
      ...
      return this.type === E.eof || this.type === E.braceR || A.test(this.input.slice(this.lastTokEnd, this.start))
    ...
    var Q = {kind: "loop"}, K = {kind: "switch"};
    G.isLet = function () {
      if (this.options.ecmaVersion < 6 || !this.isContextual("let")) return !1;
      P.lastIndex = this.pos;
      var t = P.exec(this.input), e = this.pos + t[0].length, i = this.input.charCodeAt(e);
      if (91 === i || 123 === i) return !0;
      if (g(i, !0)) {
        for (var r = e + 1; v(this.input.charCodeAt(r), !0);) ++r;
        var s = this.input.slice(e, r);
        if (!h.test(s)) return !0
      }
      return !1
    }, G.isAsyncFunction = function () {
      if (this.options.ecmaVersion < 8 || !this.isContextual("async")) return !1;
      P.lastIndex = this.pos;
      var t = P.exec(this.input), e = this.pos + t[0].length;
      return !(A.test(this.input.slice(this.pos, e)) || "function" !== this.input.slice(e, e + 8) || e + 8 !== this.input.length && v(this.input.charAt(e + 8)))
    }, G.parseStatement = function (t, e, i) {
      var r, s = this.type, n = this.startNode();
      switch (this.isLet() && (s = E._var, r = "let"), s) {
        case E._break:
        case E._continue:
        ...
        case E._function:
          return t && (this.strict || "if" !== t) && this.options.ecmaVersion >= 6 && this.unexpected(), this.parseFunctionStatement(n, !1, !t);
        case E._class:
        ...
        default:
          ...
          return s === E.name && "Identifier" === o.type && this.eat(E.colon) ? this.parseLabeledStatement(n, a, o, t) : this.parseExpressionStatement(n, o)
      }
      ...
      return this.next(), this.labels.push(Q), t.body = this.parseStatement("do"), this.labels.pop(), this.expect(E._while), t.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(E.semi) : this.semicolon(), this.finishNode(t, "DoWhileStatement")
      ...
      if (this.labels.push(Q), this.enterScope(0), this.expect(E.parenL), this.type === E.semi) return e > -1 && this.unexpected(e), this.parseFor(t, null);
      var i = this.isLet();
      if (this.type === E._var || this.type === E._const || i) {
        var r = this.startNode(), s = i ? "let" : this.value;
        return this.next(), this.parseVar(r, !0, s), this.finishNode(r, "VariableDeclaration"), !(this.type === E._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) || 1 !== r.declarations.length || "var" !== s && r.declarations[0].init ? (e > -1 && this.unexpected(e), this.parseFor(t, r)) : (this.options.ecmaVersion >= 9 && (this.type === E._in ? e > -1 && this.unexpected(e) : t.await = e > -1), this.parseForIn(t, r))
      }
      var n = new z, a = this.parseExpression(!0, n);
      return this.type === E._in || this.options.ecmaVersion >= 6 && this.isContextual("of") ? (this.options.ecmaVersion >= 9 && (this.type === E._in ? e > -1 && this.unexpected(e) : t.await = e > -1), this.toAssignable(a, !1, n), this.checkLVal(a), this.parseForIn(t, a)) : (this.checkExpressionErrors(n, !0), e > -1 && this.unexpected(e), this.parseFor(t, a))
      ...
      var e, i = this;
      this.next(), t.discriminant = this.parseParenExpression(), t.cases = [], this.expect(E.braceL), this.labels.push(K), this.enterScope(0);
      for (var r = !1; this.type !== E.braceR;) if (i.type === E._case || i.type === E._default) {
        var s = i.type === E._case;
        e && i.finishNode(e, "SwitchCase"), t.cases.push(e = i.startNode()), e.consequent = [], i.next(), s ? e.test = i.parseExpression() : (r && i.raiseRecoverable(i.lastTokStart, "Multiple default clauses"), r = !0, e.test = null), i.expect(E.colon)
      } else e || i.unexpected(), e.consequent.push(i.parseStatement(null));
      ...
      return this.next(), A.test(this.input.slice(this.lastTokEnd, this.start)) && this.raise(this.lastTokEnd, "Illegal newline after throw"), t.argument = this.parseExpression(), this.semicolon(), this.finishNode(t, "ThrowStatement")
    };
    var $ = [];
    G.parseTryStatement = function (t) {
      if (this.next(), t.block = this.parseBlock(), t.handler = null, this.type === E._catch) {
        ...
        if (this.next(), this.eat(E.parenL)) {
          ...
          this.enterScope(i ? 32 : 0), this.checkLVal(e.param, i ? 4 : 2), this.expect(E.parenR)
    ...
    }, G.parseLabeledStatement = function (t, e, i, r) {
      for (var s = this, n = 0, a = s.labels; n < a.length; n += 1) {
        a[n].name === e && s.raise(i.start, "Label '" + e + "' is already declared")
      }
      for (var o = this.type.isLoop ? "loop" : this.type === E._switch ? "switch" : null, p = this.labels.length - 1; p >= 0; p--) {
        var h = s.labels[p];
        if (h.statementStart !== t.start) break;
        h.statementStart = s.start, h.kind = o
      }
      ...
      for (void 0 === t && (t = !0), void 0 === e && (e = this.startNode()), e.body = [], this.expect(E.braceL), t && this.enterScope(0); !this.eat(E.braceR);) {
        var i = this.parseStatement(null);
        e.body.push(i)
      }
      return t && this.exitScope(), this.finishNode(e, "BlockStatement")
    }, G.parseFor = function (t, e) {
      return t.init = e, this.expect(E.semi), t.test = this.type === E.semi ? null : this.parseExpression(), this.expect(E.semi), t.update = this.type === E.parenR ? null : this.parseExpression(), this.expect(E.parenR), this.exitScope(), t.body = this.parseStatement("for"), this.labels.pop(), this.finishNode(t, "ForStatement")
    }, G.parseForIn = function (t, e) {
      var i = this.type === E._in ? "ForInStatement" : "ForOfStatement";
      return this.next(), "ForInStatement" === i && ("AssignmentPattern" === e.type || "VariableDeclaration" === e.type && null != e.declarations[0].init && (this.strict || "Identifier" !== e.declarations[0].id.type)) && this.raise(e.start, "Invalid assignment in for-in loop head"), t.left = e, t.right = "ForInStatement" === i ? this.parseExpression() : this.parseMaybeAssign(), this.expect(E.parenR), this.exitScope(), t.body = this.parseStatement("for"), this.labels.pop(), this.finishNode(t, i)
    }, G.parseVar = function (t, e, i) {
      var r = this;
      for (t.declarations = [], t.kind = i; ;) {
        var s = r.startNode();
        if (r.parseVarId(s, i), r.eat(E.eq) ? s.init = r.parseMaybeAssign(e) : "const" !== i || r.type === E._in || r.options.ecmaVersion >= 6 && r.isContextual("of") ? "Identifier" === s.id.type || e && (r.type === E._in || r.isContextual("of")) ? s.init = null : r.raise(r.lastTokEnd, "Complex binding patterns require an initialization value") : r.unexpected(), t.declarations.push(r.finishNode(s, "VariableDeclarator")), !r.eat(E.comma)) break
      }
      return t
    }, G.parseVarId = function (t, e) {
      t.id = this.parseBindingAtom(e), this.checkLVal(t.id, "var" === e ? 1 : 2, !1)
    };
    var Y = 1, Z = 2;
    G.parseFunction = function (t, e, i, r) {
      this.initFunction(t), (this.options.ecmaVersion >= 9 || this.options.ecmaVersion >= 6 && !r) && (t.generator = this.eat(E.star)), this.options.ecmaVersion >= 8 && (t.async = !!r), e & Y && (t.id = 4 & e && this.type !== E.name ? null : this.parseIdent(), !t.id || e & Z || this.checkLVal(t.id, this.inModule && !this.inFunction ? 2 : 3));
      var s = this.yieldPos, n = this.awaitPos;
      return this.yieldPos = 0, this.awaitPos = 0, this.enterScope(U(t.async, t.generator)), e & Y || (t.id = this.type === E.name ? this.parseIdent() : null), this.parseFunctionParams(t), this.parseFunctionBody(t, i), this.yieldPos = s, this.awaitPos = n, this.finishNode(t, e & Y ? "FunctionDeclaration" : "FunctionExpression")
      ...
      for (i.body = [], this.expect(E.braceL); !this.eat(E.braceR);) {
        var s = this.parseClassElement();
        s && (i.body.push(s), "MethodDefinition" === s.type && "constructor" === s.kind && (r && this.raise(s.start, "Duplicate constructor in the same class"), r = !0))
      }
      ...
      var e = this.startNode(), i = function (i, r) {
        void 0 === r && (r = !1);
        var s = t.start, n = t.startLoc;
        return !!t.eatContextual(i) && (!(t.type === E.parenL || r && t.canInsertSemicolon()) || (e.key && t.unexpected(), e.computed = !1, e.key = t.startNodeAt(s, n), e.key.name = i, t.finishNode(e.key, "Identifier"), !1))
      };
      e.kind = "method", e.static = i("static");
      var r = this.eat(E.star), s = !1;
      r || (this.options.ecmaVersion >= 8 && i("async", !0) ? (s = !0, r = this.options.ecmaVersion >= 9 && this.eat(E.star)) : i("get") ? e.kind = "get" : i("set") && (e.kind = "set")), e.key || this.parsePropertyName(e);
      var n = e.key;
      return e.computed || e.static || !("Identifier" === n.type && "constructor" === n.name || "Literal" === n.type && "constructor" === n.value) ? e.static && "Identifier" === n.type && "prototype" === n.name && this.raise(n.start, "Classes may not have a static property named prototype") : ("method" !== e.kind && this.raise(n.start, "Constructor can't have get/set modifier"), r && this.raise(n.start, "Constructor can't be a generator"), s && this.raise(n.start, "Constructor can't be an async method"), e.kind = "constructor"), this.parseClassMethod(e, r, s), "get" === e.kind && 0 !== e.value.params.length && this.raiseRecoverable(e.value.start, "getter should have no params"), "set" === e.kind && 1 !== e.value.params.length && this.raiseRecoverable(e.value.start, "setter should have exactly one param"), "set" === e.kind && "RestElement" === e.value.params[0].type && this.raiseRecoverable(e.value.params[0].start, "Setter cannot use rest params"), e
    }, G.parseClassMethod = function (t, e, i) {
      return t.value = this.parseMethod(e, i), this.finishNode(t, "MethodDefinition")
    }, G.parseClassId = function (t, e) {
      t.id = this.type === E.name ? this.parseIdent() : !0 === e ? this.unexpected() : null
    }, G.parseClassSuper = function (t) {
      t.superClass = this.eat(E._extends) ? this.parseExprSubscripts() : null
    }, G.parseExport = function (t, e) {
      if (this.next(), this.eat(E.star)) return this.expectContextual("from"), this.type !== E.string && this.unexpected(), t.source = this.parseExprAtom(), this.semicolon(), this.finishNode(t, "ExportAllDeclaration");
      if (this.eat(E._default)) {
        var i;
        if (this.checkExport(e, "default", this.lastTokStart), this.type === E._function || (i = this.isAsyncFunction())) {
          var r = this.startNode();
          this.next(), i && this.next(), t.declaration = this.parseFunction(r, 4 | Y, !1, i, !0)
      ...
      if (this.shouldParseExportStatement()) t.declaration = this.parseStatement(null), "VariableDeclaration" === t.declaration.type ? this.checkVariableExport(e, t.declaration.declarations) : this.checkExport(e, t.declaration.id.name, t.declaration.id.start), t.specifiers = [], t.source = null; else {
        if (t.declaration = null, t.specifiers = this.parseExportSpecifiers(e), this.eatContextual("from")) this.type !== E.string && this.unexpected(), t.source = this.parseExprAtom(); else {
      ...
      t && (O(t, e) && this.raiseRecoverable(i, "Duplicate export '" + e + "'"), t[e] = !0)
    }, G.checkPatternExport = function (t, e) {
      var i = e.type;
      if ("Identifier" === i) this.checkExport(t, e.name, e.start); else if ("ObjectPattern" === i) for (var r = 0, s = e.properties; r < s.length; r += 1) {
        var n = s[r];
      ...
      if (t) for (var i = 0, r = e; i < r.length; i += 1) {
        var s = r[i];
      ...
      for (this.expect(E.braceL); !this.eat(E.braceR);) {
        if (r) r = !1; else if (e.expect(E.comma), e.afterTrailingComma(E.braceR)) break;
        var s = e.startNode();
        s.local = e.parseIdent(!0), s.exported = e.eatContextual("as") ? e.parseIdent(!0) : s.local, e.checkExport(t, s.exported.name, s.exported.start), i.push(e.finishNode(s, "ExportSpecifier"))
      }
      return i
    }, G.parseImport = function (t) {
      return this.next(), this.type === E.string ? (t.specifiers = $, t.source = this.parseExprAtom()) : (t.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), t.source = this.type === E.string ? this.parseExprAtom() : this.unexpected()), this.semicolon(), this.finishNode(t, "ImportDeclaration")
    }, G.parseImportSpecifiers = function () {
      var t = this, e = [], i = !0;
      if (this.type === E.name) {
        var r = this.startNode();
        if (r.local = this.parseIdent(), this.checkLVal(r.local, 2), e.push(this.finishNode(r, "ImportDefaultSpecifier")), !this.eat(E.comma)) return e
      }
      if (this.type === E.star) {
        var s = this.startNode();
      ...
      for (this.expect(E.braceL); !this.eat(E.braceR);) {
        if (i) i = !1; else if (t.expect(E.comma), t.afterTrailingComma(E.braceR)) break;
        var n = t.startNode();
        n.imported = t.parseIdent(!0), t.eatContextual("as") ? n.local = t.parseIdent() : (t.checkUnreserved(n.imported), n.local = n.imported), t.checkLVal(n.local, 2), e.push(t.finishNode(n, "ImportSpecifier"))
      }
      return e
    ...
    tt.toAssignable = function (t, e, i) {
      ...
      for (var r = this, s = [], n = !0; !this.eat(t);) if (n ? n = !1 : r.expect(E.comma), e && r.type === E.comma) s.push(null); else {
        if (i && r.afterTrailingComma(t)) break;
        if (r.type === E.ellipsis) {
          var a = r.parseRestBinding();
          r.parseBindingListItem(a), s.push(a), r.type === E.comma && r.raise(r.start, "Comma is not permitted after the rest element"), r.expect(t);
          break
        }
        var o = r.parseMaybeDefault(r.start, r.startLoc);
        r.parseBindingListItem(o), s.push(o)
      }
      return s
      ...
      switch (void 0 === e && (e = 0), t.type) {
        case"Identifier":
          this.strict && this.reservedWordsStrictBind.test(t.name) && this.raiseRecoverable(t.start, (e ? "Binding " : "Assigning to ") + t.name + " in strict mode"), i && (O(i, t.name) && this.raiseRecoverable(t.start, "Argument name clash"), i[t.name] = !0), 0 !== e && 5 !== e && this.declareName(t.name, e, t.start);
          break;
        case"MemberExpression":
    ...
    et.checkPropClash = function (t, e, i) {
      if (!(this.options.ecmaVersion >= 9 && "SpreadElement" === t.type || this.options.ecmaVersion >= 6 && (t.computed || t.method || t.shorthand))) {
        ...
        var n = t.kind;
        if (this.options.ecmaVersion >= 6) "__proto__" === r && "init" === n && (e.proto && (i && i.doubleProto < 0 ? i.doubleProto = s.start : this.raiseRecoverable(s.start, "Redefinition of __proto__ property")), e.proto = !0); else {
          var a = e[r = "$" + r];
          if (a) ("init" === n ? this.strict && a.init || a.get || a.set : a.init || a[n]) && this.raiseRecoverable(s.start, "Redefinition of property"); else a = e[r] = {
            init: !1,
            get: !1,
            set: !1
          };
      ...
      var i = this.start, r = this.startLoc, s = this.parseMaybeAssign(t, e);
      ...
      var r = !1, s = -1, n = -1, a = -1;
      e ? (s = e.parenthesizedAssign, n = e.trailingComma, a = e.shorthandAssign, e.parenthesizedAssign = e.trailingComma = e.shorthandAssign = -1) : (e = new z, r = !0);
      ...
      if (i && (h = i.call(this, h, o, p)), this.type.isAssign) {
        ...
        return c.operator = this.value, c.left = this.type === E.eq ? this.toAssignable(h, !1, e) : h, r || z.call(e), e.shorthandAssign = -1, this.checkLVal(h), this.next(), c.right = this.parseMaybeAssign(t), this.finishNode(c, "AssignmentExpression")
      }
      return r && this.checkExpressionErrors(e, !0), s > -1 && (e.parenthesizedAssign = s), n > -1 && (e.trailingComma = n), a > -1 && (e.shorthandAssign = a), h
    }, et.parseMaybeConditional = function (t, e) {
      var i = this.start, r = this.startLoc, s = this.parseExprOps(t, e);
      ...
      var i = this.start, r = this.startLoc, s = this.parseMaybeUnary(e, !1);
      return this.checkExpressionErrors(e) || s.start === i && "ArrowFunctionExpression" === s.type ? s : this.parseExprOp(s, i, r, -1, t)
    }, et.parseExprOp = function (t, e, i, r, s) {
      var n = this.type.binop;
      if (null != n && (!s || this.type !== E._in) && n > r) {
        var a = this.type === E.logicalOR || this.type === E.logicalAND, o = this.value;
        this.next();
        var p = this.start, h = this.startLoc, c = this.parseExprOp(this.parseMaybeUnary(null, !1), p, h, n, s),
          l = this.buildBinary(e, i, t, c, o, a);
        return this.parseExprOp(l, e, i, r, s)
      }
      return t
    }, et.buildBinary = function (t, e, i, r, s, n) {
      ...
      var i, r = this, s = this.start, n = this.startLoc;
      if (this.isContextual("await") && (this.inAsync || !this.inFunction && this.options.allowAwaitOutsideFunction)) i = this.parseAwait(), e = !0; else if (this.type.prefix) {
        var a = this.startNode(), o = this.type === E.incDec;
        a.operator = this.value, a.prefix = !0, this.next(), a.argument = this.parseMaybeUnary(null, !0), this.checkExpressionErrors(t, !0), o ? this.checkLVal(a.argument) : this.strict && "delete" === a.operator && "Identifier" === a.argument.type ? this.raiseRecoverable(a.start, "Deleting local variable in strict mode") : e = !0, i = this.finishNode(a, o ? "UpdateExpression" : "UnaryExpression")
      } else {
        if (i = this.parseExprSubscripts(t), this.checkExpressionErrors(t)) return i;
        for (; this.type.postfix && !this.canInsertSemicolon();) {
          var p = r.startNodeAt(s, n);
          p.operator = r.value, p.prefix = !1, p.argument = i, r.checkLVal(i), r.next(), i = r.finishNode(p, "UpdateExpression")
        }
      }
      return !e && this.eat(E.starstar) ? this.buildBinary(s, n, i, this.parseMaybeUnary(null, !1), "**", !1) : i
    }, et.parseExprSubscripts = function (t) {
      var e = this.start, i = this.startLoc, r = this.parseExprAtom(t),
        s = "ArrowFunctionExpression" === r.type && ")" !== this.input.slice(this.lastTokStart, this.lastTokEnd);
      if (this.checkExpressionErrors(t) || s) return r;
      var n = this.parseSubscripts(r, e, i);
    ...
    }, et.parseSubscripts = function (t, e, i, r) {
      for (var s = this, n = this.options.ecmaVersion >= 8 && "Identifier" === t.type && "async" === t.name && this.lastTokEnd === t.end && !this.canInsertSemicolon() && "async" === this.input.slice(t.start, t.end), a = void 0; ;) if ((a = s.eat(E.bracketL)) || s.eat(E.dot)) {
        var o = s.startNodeAt(e, i);
        o.object = t, o.property = a ? s.parseExpression() : s.parseIdent(!0), o.computed = !!a, a && s.expect(E.bracketR), t = s.finishNode(o, "MemberExpression")
      } else if (!r && s.eat(E.parenL)) {
        var p = new z, h = s.yieldPos, c = s.awaitPos;
        s.yieldPos = 0, s.awaitPos = 0;
        var l = s.parseExprList(E.parenR, s.options.ecmaVersion >= 8, !1, p);
        if (n && !s.canInsertSemicolon() && s.eat(E.arrow)) return s.checkPatternErrors(p, !1), s.checkYieldAwaitInDefaultParams(), s.yieldPos = h, s.awaitPos = c, s.parseArrowExpression(s.startNodeAt(e, i), l, !0);
        s.checkExpressionErrors(p, !0), s.yieldPos = h || s.yieldPos, s.awaitPos = c || s.awaitPos;
        var u = s.startNodeAt(e, i);
        u.callee = t, u.arguments = l, t = s.finishNode(u, "CallExpression")
      } else {
        if (s.type !== E.backQuote) return t;
        var d = s.startNodeAt(e, i);
        d.tag = t, d.quasi = s.parseTemplate({isTagged: !0}), t = s.finishNode(d, "TaggedTemplateExpression")
      }
    }, et.parseExprAtom = function (t) {
      var e, i = this.potentialArrowAt === this.start;
      switch (this.type) {
        case E._super:
          return this.inFunction || this.raise(this.start, "'super' outside of function or class"), e = this.startNode(), this.next(), this.type !== E.dot && this.type !== E.bracketL && this.type !== E.parenL && this.unexpected(), this.finishNode(e, "Super");
        case E._this:
          return e = this.startNode(), this.next(), this.finishNode(e, "ThisExpression");
        case E.name:
          var r = this.start, s = this.startLoc, n = this.containsEsc, a = this.parseIdent(this.type !== E.name);
          ...
          if (i && !this.canInsertSemicolon()) {
            ...
            if (this.options.ecmaVersion >= 8 && "async" === a.name && this.type === E.name && !n) return a = this.parseIdent(), !this.canInsertSemicolon() && this.eat(E.arrow) || this.unexpected(), this.parseArrowExpression(this.startNodeAt(r, s), [a], !0)
          }
          return a;
        case E.regexp:
          var o = this.value;
        ...
        case E.parenL:
          var p = this.start, h = this.parseParenAndDistinguishExpression(i);
      ...
      var e, i = this, r = this.start, s = this.startLoc, n = this.options.ecmaVersion >= 8;
      if (this.options.ecmaVersion >= 6) {
        this.next();
        var a, o = this.start, p = this.startLoc, h = [], c = !0, l = !1, u = new z, d = this.yieldPos,
          f = this.awaitPos;
        for (this.yieldPos = 0, this.awaitPos = 0; this.type !== E.parenR;) {
          if (c ? c = !1 : i.expect(E.comma), n && i.afterTrailingComma(E.parenR, !0)) {
            l = !0;
            break
          }
          if (i.type === E.ellipsis) {
            a = i.start, h.push(i.parseParenItem(i.parseRestBinding())), i.type === E.comma && i.raise(i.start, "Comma is not permitted after the rest element");
            break
          }
          h.push(i.parseMaybeAssign(!1, u, i.parseParenItem))
        }
        var m = this.start, y = this.startLoc;
        if (this.expect(E.parenR), t && !this.canInsertSemicolon() && this.eat(E.arrow)) return this.checkPatternErrors(u, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = d, this.awaitPos = f, this.parseParenArrowList(r, s, h);
        h.length && !l || this.unexpected(this.lastTokStart), a && this.unexpected(a), this.checkExpressionErrors(u, !0), this.yieldPos = d || this.yieldPos, this.awaitPos = f || this.awaitPos, h.length > 1 ? ((e = this.startNodeAt(o, p)).expressions = h, this.finishNodeAt(e, "SequenceExpression", m, y)) : e = h[0]
    ...
    et.parseNew = function () {
      ...
      return t.callee = this.parseSubscripts(this.parseExprAtom(), r, s, !0), this.eat(E.parenL) ? t.arguments = this.parseExprList(E.parenR, this.options.ecmaVersion >= 8, !1) : t.arguments = it, this.finishNode(t, "NewExpression")
      ...
      for (r.quasis = [s]; !s.tail;) e.type === E.eof && e.raise(e.pos, "Unterminated template literal"), e.expect(E.dollarBraceL), r.expressions.push(e.parseExpression()), e.expect(E.braceR), r.quasis.push(s = e.parseTemplateElement({isTagged: i}));
      return this.next(), this.finishNode(r, "TemplateLiteral")
    }, et.isAsyncProp = function (t) {
      return !t.computed && "Identifier" === t.key.type && "async" === t.key.name && (this.type === E.name || this.type === E.num || this.type === E.string || this.type === E.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === E.star) && !A.test(this.input.slice(this.lastTokEnd, this.start))
    }, et.parseObj = function (t, e) {
      var i = this, r = this.startNode(), s = !0, n = {};
      for (r.properties = [], this.next(); !this.eat(E.braceR);) {
        if (s) s = !1; else if (i.expect(E.comma), i.afterTrailingComma(E.braceR)) break;
        var a = i.parseProperty(t, e);
        t || i.checkPropClash(a, n, e), r.properties.push(a)
      }
      ...
      return t.key = this.type === E.num || this.type === E.string ? this.parseExprAtom() : this.parseIdent(!0)
      ...
      var i = this.startNode(), r = this.yieldPos, s = this.awaitPos;
      return this.initFunction(i), this.options.ecmaVersion >= 6 && (i.generator = t), this.options.ecmaVersion >= 8 && (i.async = !!e), this.yieldPos = 0, this.awaitPos = 0, this.enterScope(U(e, i.generator)), this.expect(E.parenL), i.params = this.parseBindingList(E.parenR, !1, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(i, !1), this.yieldPos = r, this.awaitPos = s, this.finishNode(i, "FunctionExpression")
    }, et.parseArrowExpression = function (t, e, i) {
      var r = this.yieldPos, s = this.awaitPos;
      return this.enterScope(16 | U(i, !1)), this.initFunction(t), this.options.ecmaVersion >= 8 && (t.async = !!i), this.yieldPos = 0, this.awaitPos = 0, t.params = this.toAssignableList(e, !0), this.parseFunctionBody(t, !0), this.yieldPos = r, this.awaitPos = s, this.finishNode(t, "ArrowFunctionExpression")
    }, et.parseFunctionBody = function (t, e) {
      var i = e && this.type !== E.braceL, r = this.strict, s = !1;
      if (i) t.body = this.parseMaybeAssign(), t.expression = !0, this.checkParams(t, !1); else {
        ...
        r && !n || (s = this.strictDirective(this.end)) && n && this.raiseRecoverable(t.start, "Illegal 'use strict' directive in function with non-simple parameter list");
        var a = this.labels;
        this.labels = [], s && (this.strict = !0), this.checkParams(t, !r && !s && !e && this.isSimpleParamList(t.params)), t.body = this.parseBlock(!1), t.expression = !1, this.adaptDirectivePrologue(t.body.body), this.labels = a
      }
      this.exitScope(), this.strict && t.id && this.checkLVal(t.id, 5), this.strict = r
      ...
      var t = this.startNode();
      return this.next(), this.type === E.semi || this.canInsertSemicolon() || this.type !== E.star && !this.type.startsExpr ? (t.delegate = !1, t.argument = null) : (t.delegate = this.eat(E.star), t.argument = this.parseMaybeAssign()), this.finishNode(t, "YieldExpression")
    ...
    var st = X.prototype, nt = function (t) {
    ...
    st.enterScope = function (t) {
      ...
      this.scopeStack.pop()
    }, st.declareName = function (t, e, i) {
      var r = !1;
      if (2 === e) {
        var s = this.currentScope();
        r = s.lexical.indexOf(t) > -1 || s.var.indexOf(t) > -1, s.lexical.push(t)
      } else if (4 === e) {
        this.currentScope().lexical.push(t)
      } else if (3 === e) {
        var n = this.currentScope();
        r = n.lexical.indexOf(t) > -1, n.var.push(t)
      } else for (var a = this.scopeStack.length - 1; a >= 0; --a) {
        var o = this.scopeStack[a];
        if (o.lexical.indexOf(t) > -1 && !(32 & o.flags) && o.lexical[0] === t && (r = !0), o.var.push(t), 3 & o.flags) break
      }
    ...
    }, st.inNonArrowFunction = function () {
      for (var t = this.scopeStack.length - 1; t >= 0; t--) if (2 & this.scopeStack[t].flags && !(16 & this.scopeStack[t].flags)) return !0;
      return !1
    };
    var at = function (t, e, i) {
      this.type = "", this.start = e, this.end = 0, t.options.locations && (this.loc = new D(t, i)), t.options.directSourceFile && (this.sourceFile = t.options.directSourceFile), t.options.ranges && (this.range = [e, 0])
    }, ot = X.prototype;
    ...
    }, ot.finishNodeAt = function (t, e, i, r) {
      return pt.call(this, t, e, i, r)
    };
    var ht = function (t, e, i, r, s) {
    ...
    lt.initialContext = function () {
      ...
      return e === ct.f_expr || e === ct.f_stat || (t !== E.colon || e !== ct.b_stat && e !== ct.b_expr ? t === E._return || t === E.name && this.exprAllowed ? A.test(this.input.slice(this.lastTokEnd, this.start)) : t === E._else || t === E.semi || t === E.eof || t === E.parenR || t === E.arrow || (t === E.braceL ? e === ct.b_stat : t !== E._var && t !== E.name && !this.exprAllowed) : !e.isExpr)
      ...
      if (1 !== this.context.length) {
        ...
        t === ct.b_stat && "function" === this.curContext().token && (t = this.context.pop()), this.exprAllowed = !t.isExpr
      } else this.exprAllowed = !0
    }, E.braceL.updateContext = function (t) {
      this.context.push(this.braceIsBlock(t) ? ct.b_stat : ct.b_expr), this.exprAllowed = !0
      ...
      t.beforeExpr && t !== E.semi && t !== E._else && (t !== E.colon && t !== E.braceL || this.curContext() !== ct.b_stat) ? this.context.push(ct.f_expr) : this.context.push(ct.f_stat), this.exprAllowed = !1
      ...
      if (t === E._function) {
        ...
        this.context[e] === ct.f_expr ? this.context[e] = ct.f_expr_gen : this.context[e] = ct.f_gen
      }
      this.exprAllowed = !0
    ...
    Array.prototype.push.apply(ut.$LONE, ut.General_Category), ut.gc = ut.General_Category, ut.sc = ut.Script_Extensions = ut.scx = ut.Script;
    var dt = X.prototype, ft = function (t) {
    ...
    ft.prototype.reset = function (t, e, i) {
      ...
      return !this.switchU || r <= 55295 || r >= 57344 || t + 1 >= i ? r : (r << 10) + e.charCodeAt(t + 1) - 56613888
    }, ft.prototype.nextIndex = function (t) {
      var e = this.source, i = e.length;
      if (t >= i) return i;
      var r = e.charCodeAt(t);
      return !this.switchU || r <= 55295 || r >= 57344 || t + 1 >= i ? t + 1 : t + 2
      ...
      for (var e = t.validFlags, i = t.flags, r = 0; r < i.length; r++) {
        var s = i.charAt(r);
        -1 === e.indexOf(s) && this.raise(t.start, "Invalid regular expression flag"), i.indexOf(s, r + 1) > -1 && this.raise(t.start, "Duplicate regular expression flag")
      }
      ...
      for (var e = 0, i = t.backReferenceNames; e < i.length; e += 1) {
        var r = i[e];
        -1 === t.groupNames.indexOf(r) && t.raise("Invalid named capture referenced")
      }
      ...
      for (var e = t.pos, i = 0; -1 !== (i = t.current()) && !yt(i);) t.advance();
      return t.pos !== e
      ...
      if (t.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(t)) {
        for (t.lastStringValue += mt(t.lastIntValue); this.regexp_eatRegExpIdentifierPart(t);) t.lastStringValue += mt(t.lastIntValue);
        return !0
      }
      return !1
      ...
      var e = t.pos, i = t.current();
      return t.advance(), 92 === i && this.regexp_eatRegExpUnicodeEscapeSequence(t) && (i = t.lastIntValue), function (t) {
        return v(t, !0) || 36 === t || 95 === t || 8204 === t || 8205 === t
      }(i) ? (t.lastIntValue = i, !0) : (t.pos = e, !1)
      ...
      ut.hasOwnProperty(e) && -1 !== ut[e].indexOf(i) || t.raise("Invalid property name")
      ...
      var e = 0;
      for (t.lastStringValue = ""; vt(e = t.current());) t.lastStringValue += mt(e), t.advance();
      return "" !== t.lastStringValue
    }, dt.regexp_eatUnicodePropertyValue = function (t) {
      var e = 0;
      for (t.lastStringValue = ""; xt(e = t.current());) t.lastStringValue += mt(e), t.advance();
      return "" !== t.lastStringValue
      ...
      if (t.eat(92)) {
        ...
        if (t.switchU) {
          var i = t.current();
          (99 === i || St(i)) && t.raise("Invalid class escape"), t.raise("Invalid escape")
        }
        t.pos = e
      }
      var r = t.current();
      ...
      var e = t.pos, i = 0;
      for (t.lastIntValue = 0; bt(i = t.current());) t.lastIntValue = 10 * t.lastIntValue + (i - 48), t.advance();
      return t.pos !== e
    }, dt.regexp_eatHexDigits = function (t) {
      var e = t.pos, i = 0;
      for (t.lastIntValue = 0; _t(i = t.current());) t.lastIntValue = 16 * t.lastIntValue + kt(i), t.advance();
      return t.pos !== e
      ...
      var e = t.current();
      return St(e) ? (t.lastIntValue = e - 48, t.advance(), !0) : (t.lastIntValue = 0, !1)
    }, dt.regexp_eatFixedHexDigits = function (t, e) {
      var i = t.pos;
      t.lastIntValue = 0;
      for (var r = 0; r < e; ++r) {
        var s = t.current();
        if (!_t(s)) return t.pos = i, !1;
        t.lastIntValue = 16 * t.lastIntValue + kt(s), t.advance()
      }
      return !0
    };
    var wt = function (t) {
    ...
    Et.next = function () {
      this.options.onToken && this.options.onToken(new wt(this)), this.lastTokEnd = this.end, this.lastTokStart = this.start, this.lastTokEndLoc = this.endLoc, this.lastTokStartLoc = this.startLoc, this.nextToken()
      ...
      return g(t, this.options.ecmaVersion >= 6) || 92 === t ? this.readWord() : this.getTokenFromCode(t)
      ...
      var t, e = this.options.onComment && this.curPosition(), i = this.pos,
        r = this.input.indexOf("*/", this.pos += 2);
      if (-1 === r && this.raise(this.pos - 2, "Unterminated comment"), this.pos = r + 2, this.options.locations) for (C.lastIndex = i; (t = C.exec(this.input)) && t.index < this.pos;) ++this.curLine, this.lineStart = t.index + t[0].length;
      ...
      for (var e = this.pos, i = this.options.onComment && this.curPosition(), r = this.input.charCodeAt(this.pos += t); this.pos < this.input.length && !I(r);) r = this.input.charCodeAt(++this.pos);
      ...
      t:for (; this.pos < this.input.length;) {
        ...
        switch (e) {
          ...
          case 8232:
          case 8233:
            ++t.pos, t.options.locations && (++t.curLine, t.lineStart = t.pos);
            break;
          case 47:
            ...
            break;
          default:
            if (!(e > 8 && e < 14 || e >= 5760 && L.test(String.fromCharCode(e)))) break t;
            ++t.pos
        }
      }
      ...
      var e = this.input.charCodeAt(this.pos + 1), i = 1, r = 42 === t ? E.star : E.modulo;
      ...
      return e === t ? this.finishOp(124 === t ? E.logicalOR : E.logicalAND, 2) : 61 === e ? this.finishOp(E.assign, 2) : this.finishOp(124 === t ? E.bitwiseOR : E.bitwiseAND, 1)
      ...
      var e = this.input.charCodeAt(this.pos + 1);
      return e === t ? 45 !== e || this.inModule || 62 !== this.input.charCodeAt(this.pos + 2) || 0 !== this.lastTokEnd && !A.test(this.input.slice(this.lastTokEnd, this.pos)) ? this.finishOp(E.incDec, 2) : (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : 61 === e ? this.finishOp(E.assign, 2) : this.finishOp(E.plusMin, 1)
      ...
      for (var t, e, i = this, r = this.pos; ;) {
        i.pos >= i.input.length && i.raise(r, "Unterminated regular expression");
        var s = i.input.charAt(i.pos);
        if (A.test(s) && i.raise(r, "Unterminated regular expression"), t) t = !1; else {
      ...
      var p = this.regexpState || (this.regexpState = new ft(this));
      p.reset(r, n, o), this.validateRegExpFlags(p), this.validateRegExpPattern(p);
      var h = null;
      try {
        h = new RegExp(n, o)
      } catch (c) {
      }
      return this.finishToken(E.regexp, {pattern: n, flags: o, value: h})
    }, Et.readInt = function (t, e) {
      for (var i = this, r = this.pos, s = 0, n = 0, a = null == e ? 1 / 0 : e; n < a; ++n) {
        var o = i.input.charCodeAt(i.pos), p = void 0;
        if ((p = o >= 97 ? o - 97 + 10 : o >= 65 ? o - 65 + 10 : o >= 48 && o <= 57 ? o - 48 : 1 / 0) >= t) break;
        ++i.pos, s = s * t + p
      }
      return this.pos === r || null != e && this.pos - r !== e ? null : s
    }, Et.readRadixNumber = function (t) {
      this.pos += 2;
      var e = this.readInt(t);
      return null == e && this.raise(this.start + 2, "Expected number in radix " + t), g(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(E.num, e)
      ...
      46 !== r || i || (++this.pos, this.readInt(10), r = this.input.charCodeAt(this.pos)), 69 !== r && 101 !== r || i || (43 !== (r = this.input.charCodeAt(++this.pos)) && 45 !== r || ++this.pos, null === this.readInt(10) && this.raise(e, "Invalid number")), g(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
      var s = this.input.slice(e, this.pos), n = i ? parseInt(s, 8) : parseFloat(s);
      ...
      for (var e = this, i = "", r = ++this.pos; ;) {
        e.pos >= e.input.length && e.raise(e.start, "Unterminated string constant");
        var s = e.input.charCodeAt(e.pos);
        if (s === t) break;
        92 === s ? (i += e.input.slice(r, e.pos), i += e.readEscapedChar(!1), r = e.pos) : (I(s, e.options.ecmaVersion >= 10) && e.raise(e.start, "Unterminated string constant"), ++e.pos)
      }
      return i += this.input.slice(r, this.pos++), this.finishToken(E.string, i)
    };
    var Ct = {};
    Et.tryReadTemplateToken = function () {
      ...
      for (var t = this, e = "", i = this.pos; ;) {
        t.pos >= t.input.length && t.raise(t.start, "Unterminated template");
        var r = t.input.charCodeAt(t.pos);
        if (96 === r || 36 === r && 123 === t.input.charCodeAt(t.pos + 1)) return t.pos !== t.start || t.type !== E.template && t.type !== E.invalidTemplate ? (e += t.input.slice(i, t.pos), t.finishToken(E.template, e)) : 36 === r ? (t.pos += 2, t.finishToken(E.dollarBraceL)) : (++t.pos, t.finishToken(E.backQuote));
        if (92 === r) e += t.input.slice(i, t.pos), e += t.readEscapedChar(!0), i = t.pos; else if (I(r)) {
          switch (e += t.input.slice(i, t.pos), ++t.pos, r) {
            case 13:
          ...
          t.options.locations && (++t.curLine, t.lineStart = t.pos), i = t.pos
        } else ++t.pos
      }
    }, Et.readInvalidTemplateToken = function () {
      for (var t = this; this.pos < this.input.length; this.pos++) switch (t.input[t.pos]) {
        case"\\":
          ++t.pos;
          break;
        case"$":
        ...
        case"`":
          return t.finishToken(E.invalidTemplate, t.input.slice(t.start, t.pos))
      }
      ...
      for (var e = "", i = !0, r = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
        ...
        if (v(n, s)) t.pos += n <= 65535 ? 1 : 2; else {
          if (92 !== n) break;
          t.containsEsc = !0, e += t.input.slice(r, t.pos);
          var a = t.pos;
          117 !== t.input.charCodeAt(++t.pos) && t.invalidStringToken(t.pos, "Expecting Unicode escape sequence \\uXXXX"), ++t.pos;
          var o = t.readCodePoint();
          (i ? g : v)(o, s) || t.invalidStringToken(a, "Invalid Unicode escape"), e += At(o), r = t.pos
        }
        i = !1
      }
      return e + this.input.slice(r, this.pos)
    }, Et.readWord = function () {
      var t = this.readWord1(), e = E.name;
      return this.keywords.test(t) && (this.containsEsc && this.raiseRecoverable(this.start, "Escape sequence in keyword " + t), e = S[t]), this.finishToken(e, t)
    };
    var It = Object.freeze({
        ...
        hearts: "♥",
        diams: "♦"
      }, Pt = /^[\da-fA-F]+$/, Nt = /^\d+$/, Tt = It.tokTypes, Rt = It.TokContext, Ot = It.tokContexts, jt = It.TokenType,
      Vt = It.isNewLine, Dt = It.isIdentifierStart, Ft = It.isIdentifierChar, Bt = new Rt("<tag", !1),
      Mt = new Rt("</tag", !1), Ut = new Rt("<tag>...</tag>", !0, !0), qt = {
    ...
    function Xt(t) {
      return t ? "JSXIdentifier" === t.type ? t.name : "JSXNamespacedName" === t.type ? t.namespace.name + ":" + t.name.name : "JSXMemberExpression" === t.type ? Xt(t.object) + "." + Xt(t.property) : void 0 : t
    }
    ...
    qt.jsxTagStart.updateContext = function () {
      ...
      e === Bt && t === Tt.slash || e === Mt ? (this.context.pop(), this.exprAllowed = this.curContext() === Ut) : this.exprAllowed = !0
    };
    var Jt = function (t) {
      return void 0 === t && (t = {}), function (e) {
        return function (t, e) {
          return function (e) {
            ...
            return e && (i.__proto__ = e), i.prototype = Object.create(e && e.prototype), i.prototype.constructor = i, i.prototype.jsx_readToken = function () {
              for (var t = this, e = "", i = this.pos; ;) {
                t.pos >= t.input.length && t.raise(t.start, "Unterminated JSX contents");
                var r = t.input.charCodeAt(t.pos);
                switch (r) {
                  case 60:
                  case 123:
                    return t.pos === t.start ? 60 === r && t.exprAllowed ? (++t.pos, t.finishToken(qt.jsxTagStart)) : t.getTokenFromCode(r) : (e += t.input.slice(i, t.pos), t.finishToken(qt.jsxText, e));
                  case 38:
                    e += t.input.slice(i, t.pos), e += t.jsx_readEntity(), i = t.pos;
                    break;
                  default:
                    Vt(r) ? (e += t.input.slice(i, t.pos), e += t.jsx_readNewLine(!0), i = t.pos) : ++t.pos
                }
              }
            }, i.prototype.jsx_readNewLine = function (t) {
              var e, i = this.input.charCodeAt(this.pos);
              ...
              for (var e = this, i = "", r = ++this.pos; ;) {
                ...
                var s = e.input.charCodeAt(e.pos);
                if (s === t) break;
                38 === s ? (i += e.input.slice(r, e.pos), i += e.jsx_readEntity(), r = e.pos) : Vt(s) ? (i += e.input.slice(r, e.pos), i += e.jsx_readNewLine(!1), r = e.pos) : ++e.pos
              }
              return i += this.input.slice(r, this.pos++), this.finishToken(Tt.string, i)
            }, i.prototype.jsx_readEntity = function () {
              var t, e = this, i = "", r = 0, s = this.input[this.pos];
              "&" !== s && this.raise(this.pos, "Entity must start with an ampersand");
              for (var n = ++this.pos; this.pos < this.input.length && r++ < 10;) {
                if (";" === (s = e.input[e.pos++])) {
                  "#" === i[0] ? "x" === i[1] ? (i = i.substr(2), Pt.test(i) && (t = String.fromCharCode(parseInt(i, 16)))) : (i = i.substr(1), Nt.test(i) && (t = String.fromCharCode(parseInt(i, 10)))) : t = Lt[i];
                  break
                }
                i += s
              }
              ...
              var t, e = this, i = this.pos;
              do {
                t = e.input.charCodeAt(++e.pos)
              } while (Ft(t) || 45 === t);
              return this.finishToken(qt.jsxName, this.input.slice(i, this.pos))
            }, i.prototype.jsx_parseIdentifier = function () {
              var t = this.startNode();
              return this.type === qt.jsxName ? t.name = this.value : this.type.keyword ? t.name = this.type.keyword : this.unexpected(), this.next(), this.finishNode(t, "JSXIdentifier")
            }, i.prototype.jsx_parseNamespacedName = function () {
              var e = this.start, i = this.startLoc, r = this.jsx_parseIdentifier();
              ...
              var i = this.start, r = this.startLoc, s = this.jsx_parseNamespacedName();
              for (this.type !== Tt.dot || "JSXNamespacedName" !== s.type || t.allowNamespacedObjects || this.unexpected(); this.eat(Tt.dot);) {
                var n = e.startNodeAt(i, r);
                n.object = s, n.property = e.jsx_parseIdentifier(), s = e.finishNode(n, "JSXMemberExpression")
              }
              return s
              ...
              var t = this.startNode();
              return this.next(), t.expression = this.type === Tt.braceR ? this.jsx_parseEmptyExpression() : this.parseExpression(), this.expect(Tt.braceR), this.finishNode(t, "JSXExpressionContainer")
            }, i.prototype.jsx_parseAttribute = function () {
              var t = this.startNode();
              return this.eat(Tt.braceL) ? (this.expect(Tt.ellipsis), t.argument = this.parseMaybeAssign(), this.expect(Tt.braceR), this.finishNode(t, "JSXSpreadAttribute")) : (t.name = this.jsx_parseNamespacedName(), t.value = this.eat(Tt.eq) ? this.jsx_parseAttributeValue() : null, this.finishNode(t, "JSXAttribute"))
            }, i.prototype.jsx_parseOpeningElementAt = function (t, e) {
              var i = this, r = this.startNodeAt(t, e);
              r.attributes = [];
              var s = this.jsx_parseElementName();
              for (s && (r.name = s); this.type !== Tt.slash && this.type !== qt.jsxTagEnd;) r.attributes.push(i.jsx_parseAttribute());
              return r.selfClosing = this.eat(Tt.slash), this.expect(qt.jsxTagEnd), this.finishNode(r, s ? "JSXOpeningElement" : "JSXOpeningFragment")
            }, i.prototype.jsx_parseClosingElementAt = function (t, e) {
              var i = this.startNodeAt(t, e), r = this.jsx_parseElementName();
              return r && (i.name = r), this.expect(qt.jsxTagEnd), this.finishNode(i, r ? "JSXClosingElement" : "JSXClosingFragment")
            }, i.prototype.jsx_parseElementAt = function (t, e) {
              var i = this, r = this.startNodeAt(t, e), s = [], n = this.jsx_parseOpeningElementAt(t, e), a = null;
              if (!n.selfClosing) {
                t:for (; ;) switch (i.type) {
                  case qt.jsxTagStart:
                    if (t = i.start, e = i.startLoc, i.next(), i.eat(Tt.slash)) {
                      a = i.jsx_parseClosingElementAt(t, e);
                      break t
                    }
                    s.push(i.jsx_parseElementAt(t, e));
                    break;
                  case qt.jsxText:
                    s.push(i.parseExprAtom());
                    break;
                  case Tt.braceL:
                    s.push(i.jsx_parseExpressionContainer());
                    break;
                  default:
                    i.unexpected()
                }
                Xt(a.name) !== Xt(n.name) && this.raise(a.start, "Expected corresponding JSX closing tag for <" + Xt(n.name) + ">")
              }
              var o = n.name ? "Element" : "Fragment";
              return r["opening" + o] = n, r["closing" + o] = a, r.children = s, this.type === Tt.relational && "<" === this.value && this.raise(this.start, "Adjacent JSX elements must be wrapped in an enclosing tag"), this.finishNode(r, "JSX" + o)
              ...
              return this.type === qt.jsxText ? this.jsx_parseText(this.value) : this.type === qt.jsxTagStart ? this.jsx_parseElement() : e.prototype.parseExprAtom.call(this, t)
            }, i.prototype.readToken = function (t) {
              var i = this.curContext();
              if (i === Ut) return this.jsx_readToken();
              if (i === Bt || i === Mt) {
                if (Dt(t)) return this.jsx_readWord();
                if (62 == t) return ++this.pos, this.finishToken(qt.jsxTagEnd);
                if ((34 === t || 39 === t) && i == Bt) return this.jsx_readString(t)
              }
              return 60 === t && this.exprAllowed && 33 !== this.input.charCodeAt(this.pos + 1) ? (++this.pos, this.finishToken(qt.jsxTagStart)) : e.prototype.readToken.call(this, t)
            }, i.prototype.updateContext = function (t) {
              if (this.type == Tt.braceL) {
                var i = this.curContext();
                i == Bt ? this.context.push(Ot.b_expr) : i == Ut ? this.context.push(Ot.b_tmpl) : e.prototype.updateContext.call(this, t), this.exprAllowed = !0
              } else {
                if (this.type !== Tt.slash || t !== qt.jsxTagStart) return e.prototype.updateContext.call(this, t);
                this.context.length -= 2, this.context.push(Mt), this.exprAllowed = !1
              }
            }, i
          }(e)
        }({allowNamespaces: !1 !== t.allowNamespaces, allowNamespacedObjects: !!t.allowNamespacedObjects}, e)
      }
    };
    Jt.tokTypes = qt;
    var Wt, Ht, zt, Gt = (Wt = function (t, e) {
        Object.defineProperty(e, "__esModule", {value: !0}), e.DynamicImportKey = void 0;
        var i = function () {
          function t(t, e) {
        ...
        e.default = function (t) {
          return function (t) {
            ...
            return function (t, e) {
              ...
              key: "parseStatement", value: function (t, i, s) {
                return this.type === It.tokTypes._import && p.call(this) ? this.parseExpressionStatement(this.startNode(), this.parseExpression()) : r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "parseStatement", this).call(this, t, i, s)
              }
            }, {
              key: "parseExprAtom", value: function (t) {
                return this.type === It.tokTypes._import ? o.call(this) : r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "parseExprAtom", this).call(this, t)
              }
            }]), e
          }(t)
        };
        ...
        function o() {
          var t = this.startNode();
          return this.next(), this.type !== It.tokTypes.parenL && this.unexpected(), this.finishNode(t, a)
        }
      ...
      }, Wt(Ht = {exports: {}}, Ht.exports), Ht.exports),
      Qt = (zt = Gt) && zt.__esModule && Object.prototype.hasOwnProperty.call(zt, "default") ? zt.default : zt;
    Gt.DynamicImportKey;

    function Kt(t) {
      var e = {};
      return Object.keys(t).forEach((function (i) {
        "parent" !== i && "program" !== i && "keys" !== i && "__wrapped" !== i && (Array.isArray(t[i]) ? e[i] = t[i].map(Kt) : t[i] && t[i].toJSON ? e[i] = t[i].toJSON() : e[i] = t[i])
      })), e
    }
    ...
    function Yt(t) {
      var e = [];
      return Zt[t.type](e, t), e
    }

    $t.prototype.ancestor = function (t) {
      ...
      return !1
    }, $t.prototype.findLexicalBoundary = function () {
      return this.parent.findLexicalBoundary()
    }, $t.prototype.findNearest = function (t) {
      return "string" == typeof t && (t = new RegExp("^" + t + "$")), t.test(this.type) ? this : this.parent.findNearest(t)
    }, $t.prototype.unparenthesizedParent = function () {
      for (var t = this.parent; t && "ParenthesizedExpression" === t.type;) t = t.parent;
      return t
    }, $t.prototype.unparenthesize = function () {
      for (var t = this; "ParenthesizedExpression" === t.type;) t = t.expression;
      return t
    }, $t.prototype.findScope = function (t) {
      return this.parent.findScope(t)
    }, $t.prototype.getIndentation = function () {
    ...
    var Zt = {
      Identifier: function (t, e) {
        ...
        Zt[e.argument.type](t, e.argument)
      }, AssignmentPattern: function (t, e) {
        Zt[e.left.type](t, e.left)
      }
    }, te = Object.create(null);

    function ee(t) {
      t = t || {}, this.parent = t.parent, this.isBlockScope = !!t.block, this.createDeclarationCallback = t.declare;
    ...
    function se(t, e, i) {
      void 0 === i && (i = 1);
      var r = Math.max(e.line - 5, 0), s = e.line, n = String(s).length, a = t.split("\n").slice(r, s),
        o = a[a.length - 1].slice(0, e.column).replace(/\t/g, "  ").length, p = a.map((function (t, e) {
          return i = n, (s = String(e + r + 1)) + re(" ", i - s.length) + " : " + t.replace(/\t/g, "  ");
          var i, s
        })).join("\n");
      return p += "\n" + re(" ", n + 3 + o) + re("^", i)
    }
    ...
    "do if in for let new try var case else enum eval null this true void with await break catch class const false super throw while yield delete export import public return static switch typeof default extends finally package private continue debugger function arguments interface protected implements instanceof".split(" ").forEach((function (t) {
      ...
      addDeclaration: function (t, e) {
        for (var i = this, r = 0, s = Yt(t); r < s.length; r += 1) {
          var n = s[r], a = n.name, o = {name: a, node: n, kind: e, instances: []};
          i.declarations[a] = o, i.isBlockScope && (i.functionScope.blockScopedDeclarations[a] || (i.functionScope.blockScopedDeclarations[a] = []), i.functionScope.blockScopedDeclarations[a].push(o))
        }
        ...
        for (var e = t = t.replace(/\s/g, "").replace(/\[([^\]]+)\]/g, "_$1").replace(/[^a-zA-Z0-9_$]/g, "_").replace(/_{2,}/, "_"), i = 1; this.declarations[e] || this.references[e] || this.aliases[e] || e in te;) e = t + "$" + i++;
    ...
    var ne = function (t) {
      function e(e, i) {
        if (t.call(this, e), this.name = "CompileError", i) {
          var r = i.program.magicString.original, s = ie(r, i.start);
          this.message = e + " (" + s.line + ":" + s.column + ")", this.stack = (new t).stack.replace(new RegExp(".+new " + this.name + ".+\\n", "m"), ""), this.loc = s, this.snippet = se(r, s, i.end - i.start)
        }
      }
    ...
    var oe = {
      Identifier: he, AssignmentPattern: function (t, e, i, r, s, n, a) {
        var o = "Identifier" === r.left.type, p = o ? r.left.name : s;
        n || a.push((function (e, i, s) {
          t.prependRight(r.left.end, i + "if ( " + p + " === void 0 ) " + p), t.move(r.left.end, r.right.end, e), t.appendLeft(r.right.end, s)
        }));
        o || pe(t, e, i, r.left, s, n, a)
      }, ArrayPattern: function (t, e, i, r, s, n, a) {
        var o = r.start;
        r.elements.forEach((function (r, p) {
          r && ("RestElement" === r.type ? le(t, e, i, o, r.argument, s + ".slice(" + p + ")", n, a) : le(t, e, i, o, r, s + "[" + p + "]", n, a), o = r.end)
        })), t.remove(o, r.end)
      }, ObjectPattern: ce
    };

    function pe(t, e, i, r, s, n, a) {
      oe[r.type](t, e, i, r, s, n, a)
    }

    function he(t, e, i, r, s, n, a) {
      a.push((function (e, a, o) {
        t.overwrite(r.start, r.end, (n ? a : a + "var ") + i(r) + " = " + s + o), t.move(r.start, r.end, e)
      }))
    }

    function ce(t, e, i, r, s, n, a) {
      var o = this, p = r.start, h = [];
      r.properties.forEach((function (r) {
        var c, l;
        if ("Property" === r.type) {
          var u = r.computed || "Identifier" !== r.key.type, d = u ? t.slice(r.key.start, r.key.end) : r.key.name;
          c = u ? s + "[" + d + "]" : s + "." + d, l = r.value, h.push(u ? d : '"' + d + '"')
        } else {
          if ("RestElement" !== r.type) throw new ne(o, "Unexpected node of type " + r.type + " in object pattern");
          l = r.argument, c = e("rest"), a.push((function (e, i, a) {
            var o = r.program.getObjectWithoutPropertiesHelper(t);
            t.overwrite(r.start, p = r.argument.start, (n ? i : i + "var ") + c + " = " + o + "( " + s + ", [" + h.join(", ") + "] )" + a), t.move(r.start, p, e)
          }))
        }
        le(t, e, i, p, l, c, n, a), p = r.end
      })), t.remove(p, r.end)
    }

    function le(t, e, i, r, s, n, a, o) {
      switch (s.type) {
        case"Identifier":
          t.remove(r, s.start), he(t, 0, i, s, n, a, o);
          break;
        case"MemberExpression":
          t.remove(r, s.start), function (t, e, i, r, s, n, a) {
            a.push((function (e, i, a) {
              t.prependRight(r.start, n ? i : i + "var "), t.appendLeft(r.end, " = " + s + a), t.move(r.start, r.end, e)
            }))
          }(t, 0, 0, s, n, !0, o);
          break;
        case"AssignmentPattern":
          var p, h = "Identifier" === s.left.type;
          p = h ? i(s.left) : e(n), o.push((function (e, i, r) {
            a ? (t.prependRight(s.right.start, p + " = " + n + ", " + p + " = " + p + " === void 0 ? "), t.appendLeft(s.right.end, " : " + p + r)) : (t.prependRight(s.right.start, i + "var " + p + " = " + n + "; if ( " + p + " === void 0 ) " + p + " = "), t.appendLeft(s.right.end, r)), t.move(s.right.start, s.right.end, e)
          })), h ? t.remove(r, s.right.start) : (t.remove(r, s.left.start), t.remove(s.left.end, s.right.start), le(t, e, i, r, s.left, p, a, o));
          break;
        case"ObjectPattern":
          t.remove(r, r = s.start);
          var c = n;
          s.properties.length > 1 && (c = e(n), o.push((function (e, i, o) {
            t.prependRight(s.start, (a ? "" : i + "var ") + c + " = "), t.overwrite(s.start, r = s.start + 1, n), t.appendLeft(r, o), t.overwrite(s.start, r = s.start + 1, (a ? "" : i + "var ") + c + " = " + n + o), t.move(s.start, r, e)
          }))), ce(t, e, i, s, c, a, o);
          break;
        case"ArrayPattern":
          if (t.remove(r, r = s.start), s.elements.filter(Boolean).length > 1) {
            var l = e(n);
            o.push((function (e, i, o) {
              t.prependRight(s.start, (a ? "" : i + "var ") + l + " = "), t.overwrite(s.start, r = s.start + 1, n, {contentOnly: !0}), t.appendLeft(r, o), t.move(s.start, r, e)
            })), s.elements.forEach((function (s, n) {
              s && ("RestElement" === s.type ? le(t, e, i, r, s.argument, l + ".slice(" + n + ")", a, o) : le(t, e, i, r, s, l + "[" + n + "]", a, o), r = s.end)
            }))
          } else {
            var u = ae(s.elements, Boolean), d = s.elements[u];
            "RestElement" === d.type ? le(t, e, i, r, d.argument, n + ".slice(" + u + ")", a, o) : le(t, e, i, r, d, n + "[" + u + "]", a, o), r = d.end
          }
          t.remove(r, s.end);
          break;
        default:
          throw new Error("Unexpected node type in destructuring (" + s.type + ")")
      }
    }
    ...
    var ue = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.createScope = function () {
        var t = this;
        this.parentIsFunction = /Function/.test(this.parent.type), this.isFunctionBlock = this.parentIsFunction || "Root" === this.parent.type, this.scope = new ee({
        ...
        return "Program" === this.type || /^Function/.test(this.parent.type) ? this : this.parent.findLexicalBoundary()
        ...
        if (void 0 === this.indentation) {
          for (var e = this.program.magicString.original, i = this.synthetic || !this.body.length, r = i ? this.start : this.body[0].start; r && "\n" !== e[r];) r -= 1;
          for (this.indentation = ""; ;) {
            var s = e[r += 1];
            if (" " !== s && "\t" !== s) break;
            t.indentation += s
          }
          for (var n = this.program.magicString.getIndentString(), a = this.parent; a;) "constructor" !== a.kind || a.parent.parent.superClass || (t.indentation = t.indentation.replace(n, "")), a = a.parent;
          i && (this.indentation += n)
        }
        return this.indentation
      }, e.prototype.transpile = function (e, i) {
        var r, s, n = this, a = this.getIndentation(), o = [];
        if (this.argumentsAlias && o.push((function (t, i, r) {
          var s = i + "var " + n.argumentsAlias + " = arguments" + r;
          e.appendLeft(t, s)
        })), this.thisAlias && o.push((function (t, i, r) {
          var s = i + "var " + n.thisAlias + " = this" + r;
          e.appendLeft(t, s)
        })), this.argumentsArrayAlias && o.push((function (t, i, r) {
          var s = n.scope.createIdentifier("i"),
            o = i + "var " + s + " = arguments.length, " + n.argumentsArrayAlias + " = Array(" + s + ");\n" + a + "while ( " + s + "-- ) " + n.argumentsArrayAlias + "[" + s + "] = arguments[" + s + "]" + r;
          e.appendLeft(t, o)
          ...
          var s = i + "var " + n.createdDeclarations.join(", ") + r;
          e.appendLeft(t, s)
        ...
        s = this.body[0], r = s && "ExpressionStatement" === s.type && "Literal" === s.expression.type && "use strict" === s.expression.value ? this.body[0].end : this.synthetic || "Root" === this.parent.type ? this.start : this.start + 1;
        var h = "\n" + a, c = ";";
        o.forEach((function (t, e) {
          e === o.length - 1 && (c = ";\n"), t(r, h, c)
        }))
      }, e.prototype.transpileParameters = function (t, e, i, r, s) {
        var n = this;
        t.forEach((function (a) {
          if ("AssignmentPattern" === a.type && "Identifier" === a.left.type) i.defaultParameter && s.push((function (t, i, r) {
            var s = i + "if ( " + a.left.name + " === void 0 ) " + a.left.name;
            e.prependRight(a.left.end, s).move(a.left.end, a.right.end, t).appendLeft(a.right.end, r)
          })); else if ("RestElement" === a.type) i.spreadRest && s.push((function (i, s, o) {
            var p = t[t.length - 2];
            if (p) e.remove(p ? p.end : a.start, a.end); else {
              for (var h = a.start, c = a.end; /\s/.test(e.original[h - 1]);) h -= 1;
              for (; /\s/.test(e.original[c]);) c += 1;
              e.remove(h, c)
            }
            var l = a.argument.name, u = n.scope.createIdentifier("len"), d = t.length - 1;
            d ? e.prependRight(i, s + "var " + l + " = [], " + u + " = arguments.length - " + d + ";\n" + r + "while ( " + u + "-- > 0 ) " + l + "[ " + u + " ] = arguments[ " + u + " + " + d + " ]" + o) : e.prependRight(i, s + "var " + l + " = [], " + u + " = arguments.length;\n" + r + "while ( " + u + "-- ) " + l + "[ " + u + " ] = arguments[ " + u + " ]" + o)
            ...
            }), a, o, !1, s), e.prependRight(a.start, o)
          }
        }))
      }, e.prototype.transpileBlockScopedIdentifiers = function (t) {
        var e = this;
        Object.keys(this.scope.blockScopedDeclarations).forEach((function (i) {
          for (var r = 0, s = e.scope.blockScopedDeclarations[i]; r < s.length; r += 1) {
            var n = s[r], a = !1;
            if ("for.let" === n.kind) {
              var o = n.node.findNearest("ForStatement");
              if (o.shouldRewriteAsFunction) {
                var p = e.scope.createIdentifier(i), h = o.reassigned[i] ? e.scope.createIdentifier(i) : i;
                n.name = p, t.overwrite(n.node.start, n.node.end, p, {storeName: !0}), o.aliases[i] = {
                  outer: p,
                  inner: h
                };
                for (var c = 0, l = n.instances; c < l.length; c += 1) {
                  var u = l[c], d = o.body.contains(u) ? h : p;
                  i !== d && t.overwrite(u.start, u.end, d, {storeName: !0})
                }
                a = !0
              }
            }
            if (!a) {
              ...
              if (i !== f) {
                n.name = f, t.overwrite(n.node.start, n.node.end, f, {storeName: !0});
                for (var m = 0, y = n.instances; m < y.length; m += 1) {
                  var g = y[m];
                  g.rewritten = !0, t.overwrite(g.start, g.end, f, {storeName: !0})
                }
              }
            }
          }
    ...
    function fe(t, e, i, r, s) {
      for (var n = e.length, a = -1; n--;) {
        var o = e[n];
        o && "SpreadElement" === o.type && (de(o.argument) && t.overwrite(o.argument.start, o.argument.end, r), a = n)
      }
      if (-1 === a) return !1;
      if (s) {
      ...
      var h = e[a], c = e[a - 1];
      for (c ? t.overwrite(c.end, h.start, " ].concat( ") : (t.remove(i, h.start), t.overwrite(h.end, e[1].start, ".concat( ")), n = a; n < e.length; n += 1) (h = e[n]) && ("SpreadElement" === h.type ? t.remove(h.start, h.argument.start) : (t.appendLeft(h.start, "["), t.appendLeft(h.end, "]")));
      return !0
    }
    ...
    var me = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.spreadRest && this.elements.length) for (var i = this.findLexicalBoundary(), r = this.elements.length; r--;) {
          var s = this.elements[r];
          s && "SpreadElement" === s.type && de(s.argument) && (this.argumentsArrayAlias = i.getArgumentsArrayAlias())
        }
        ...
        if (t.prototype.transpile.call(this, e, i), i.spreadRest) {
          if (this.elements.length) {
            ...
            r && /\s*,/.test(e.original.slice(r.end, this.end)) && e.overwrite(r.end, this.end - 1, " ")
          }
          if (1 === this.elements.length) {
            var s = this.elements[0];
            s && "SpreadElement" === s.type && (de(s.argument) ? e.overwrite(this.start, this.end, "[].concat( " + this.argumentsArrayAlias + " )") : (e.overwrite(this.start, s.argument.start, "[].concat( "), e.overwrite(s.end, this.end, " )")))
          } else {
            fe(e, this.elements, this.start, this.argumentsArrayAlias) && e.overwrite(this.end - 1, this.end, ")")
          }
        }
      }, e
    }($t);
    ...
    function ye(t, e) {
      for (; ")" !== t.original[e];) {
        ...
        "/" === t.original[e] && (e = t.original.indexOf("/" === t.original[e + 1] ? "\n" : "*/", e) + 1), e += 1
      }
    }
    ...
    var ge = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        ...
        if (i.arrow || this.needsArguments(i)) {
          for (var s = this.body.start; "=" !== e.original[s];) s -= 1;
          e.remove(s, this.body.start), t.prototype.transpile.call(this, e, i), r && (e.prependRight(this.params[0].start, "("), e.appendLeft(this.params[0].end, ")")), this.parent && "ExpressionStatement" === this.parent.type ? e.prependRight(this.start, "!function") : e.prependRight(this.start, "function ")
        } else t.prototype.transpile.call(this, e, i);
        i.trailingFunctionCommas && this.params.length && !r && ye(e, this.params[this.params.length - 1].end)
    ...
    function ve(t, e) {
      ...
      if (i && "const" === i.kind) throw new ne(t.name + " is read-only", t)
    }
    ...
    var xe = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if ("Identifier" === this.left.type) {
          var i = this.findScope(!1).findDeclaration(this.left.name), r = i && i.node.ancestor(3);
          r && "ForStatement" === r.type && r.body.contains(this) && (r.reassigned[this.left.name] = !0)
        }
        t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        "Identifier" === this.left.type && ve(this.left, this.findScope(!1)), "**=" === this.operator && i.exponentiation ? this.transpileExponentiation(e, i) : /Pattern/.test(this.left.type) && i.destructuring && this.transpileDestructuring(e), t.prototype.transpile.call(this, e, i)
      }, e.prototype.transpileDestructuring = function (t) {
        var e = this, i = this.findScope(!0), r = this.findScope(!1), s = i.createDeclaration("assign");
        t.appendRight(this.left.end, "(" + s), t.appendLeft(this.right.end, ", ");
        var n = [];
        pe(t, (function (t) {
        ...
        })), "ExpressionStatement" === this.unparenthesizedParent().type ? t.prependRight(this.end, ")") : t.appendRight(this.end, ", " + s + ")")
      }, e.prototype.transpileExponentiation = function (t) {
        for (var e, i = this.findScope(!1), r = this.left.end; "*" !== t.original[r];) r += 1;
        t.remove(r, r + 2);
        var s = this.left.unparenthesize();
        if ("Identifier" === s.type) e = i.resolveName(s.name); else if ("MemberExpression" === s.type) {
          var n, a, o = !1, p = !1, h = this.findNearest(/(?:Statement|Declaration)$/), c = h.getIndentation();
          "Identifier" === s.property.type ? a = s.computed ? i.resolveName(s.property.name) : s.property.name : (a = i.createDeclaration("property"), p = !0), "Identifier" === s.object.type ? n = i.resolveName(s.object.name) : (n = i.createDeclaration("object"), o = !0), s.start === h.start ? o && p ? (t.prependRight(h.start, n + " = "), t.overwrite(s.object.end, s.property.start, ";\n" + c + a + " = "), t.overwrite(s.property.end, s.end, ";\n" + c + n + "[" + a + "]")) : o ? (t.prependRight(h.start, n + " = "), t.appendLeft(s.object.end, ";\n" + c), t.appendLeft(s.object.end, n)) : p && (t.prependRight(s.property.start, a + " = "), t.appendLeft(s.property.end, ";\n" + c), t.move(s.property.start, s.property.end, this.start), t.appendLeft(s.object.end, "[" + a + "]"), t.remove(s.object.end, s.property.start), t.remove(s.property.end, s.end)) : (o && p ? (t.prependRight(s.start, "( " + n + " = "), t.overwrite(s.object.end, s.property.start, ", " + a + " = "), t.overwrite(s.property.end, s.end, ", " + n + "[" + a + "]")) : o ? (t.prependRight(s.start, "( " + n + " = "), t.appendLeft(s.object.end, ", " + n)) : p && (t.prependRight(s.property.start, "( " + a + " = "), t.appendLeft(s.property.end, ", "), t.move(s.property.start, s.property.end, s.start), t.overwrite(s.object.end, s.property.start, "[" + a + "]"), t.remove(s.property.end, s.end)), p && t.appendLeft(this.end, " )")), e = n + (s.computed || p ? "[" + a + "]" : "." + a)
        }
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
    ...
    }($t), _e = /(?:For(?:In|Of)?|While)Statement/, ke = function (t) {
      function e() {
        t.apply(this, arguments)
      }

      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function () {
        var t = this.findNearest(_e), e = this.findNearest("SwitchCase");
        t && (!e || t.depth > e.depth) && (t.canBreak = !0, this.loop = t)
      }, e.prototype.transpile = function (t) {
        if (this.loop && this.loop.shouldRewriteAsFunction) {
          if (this.label) throw new ne("Labels are not currently supported in a loop with locally-scoped variables", this);
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.spreadRest && this.arguments.length > 1) for (var i = this.findLexicalBoundary(), r = this.arguments.length; r--;) {
          var s = this.arguments[r];
          "SpreadElement" === s.type && de(s.argument) && (this.argumentsArrayAlias = i.getArgumentsArrayAlias())
        }
        t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        if (i.spreadRest && this.arguments.length) {
          var r, s = !1, n = this.arguments[0];
          if (1 === this.arguments.length ? "SpreadElement" === n.type && (e.remove(n.start, n.argument.start), s = !0) : s = fe(e, this.arguments, n.start, this.argumentsArrayAlias), s) {
            var a = null;
            if ("Super" === this.callee.type ? a = this.callee : "MemberExpression" === this.callee.type && "Super" === this.callee.object.type && (a = this.callee.object), a || "MemberExpression" !== this.callee.type) r = "void 0"; else if ("Identifier" === this.callee.object.type) r = this.callee.object.name; else {
              r = this.findScope(!0).createDeclaration("ref");
              var o = this.callee.object;
              e.prependRight(o.start, "(" + r + " = "), e.appendLeft(o.end, ")")
            }
            e.appendLeft(this.callee.end, ".apply"), a ? (a.noCall = !0, this.arguments.length > 1 && ("SpreadElement" !== n.type && e.prependRight(n.start, "[ "), e.appendLeft(this.arguments[this.arguments.length - 1].end, " )"))) : 1 === this.arguments.length ? e.prependRight(n.start, r + ", ") : ("SpreadElement" === n.type ? e.appendLeft(n.start, r + ", ") : e.appendLeft(n.start, r + ", [ "), e.appendLeft(this.arguments[this.arguments.length - 1].end, " )"))
          }
        }
        i.trailingFunctionCommas && this.arguments.length && ye(e, this.arguments[this.arguments.length - 1].end), t.prototype.transpile.call(this, e, i)
      }, e
    }($t), we = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i, r, s) {
        var n = this;
        if (i.classes) {
          var a = this.parent.name, o = e.getIndentString(), p = this.getIndentation() + (r ? o : ""), h = p + o,
            c = ae(this.body, (function (t) {
          ...
          if (this.body.length ? (e.remove(this.start, this.body[0].start), e.remove(this.body[this.body.length - 1].end, this.end)) : e.remove(this.start, this.end), l) {
            ...
            var f = this.body[c - 1], m = this.body[c + 1];
            c > 0 && (e.remove(f.end, l.start), e.move(l.start, m ? m.start : this.end - 1, this.body[0].start)), r || e.appendLeft(l.end, ";")
          }
          var y = !1 !== this.program.options.namedFunctionExpressions,
            g = y || this.parent.superClass || "ClassDeclaration" !== this.parent.type;
          if (this.parent.superClass) {
            var v = "if ( " + s + " ) " + a + ".__proto__ = " + s + ";\n" + p + a + ".prototype = Object.create( " + s + " && " + s + ".prototype );\n" + p + a + ".prototype.constructor = " + a + ";";
          ...
          var b, _, k = this.findScope(!1), S = [], w = [];
          if (this.body.forEach((function (t, r) {
            if (("get" === t.kind || "set" === t.kind) && i.getterSetter) throw new ne("getters and setters are not supported. Use `transforms: { getterSetter: false }` to skip transformation and disable this error", t);
            if ("constructor" !== t.kind) {
              if (t.static) {
                var s = " " == e.original[t.start + 6] ? 7 : 6;
                e.remove(t.start, t.start + s)
              }
              var o, h = "method" !== t.kind, l = t.key.name;
              (te[l] || t.value.body.scope.references[l]) && (l = k.createIdentifier(l));
              var u = !1;
              if (t.computed || "Literal" !== t.key.type || (u = !0, t.computed = !0), h) {
                if (t.computed) throw new Error("Computed accessor properties are not currently supported");
                e.remove(t.start, t.key.start), t.static ? (~w.indexOf(t.key.name) || w.push(t.key.name), _ || (_ = k.createIdentifier("staticAccessors")), o = "" + _) : (~S.indexOf(t.key.name) || S.push(t.key.name), b || (b = k.createIdentifier("prototypeAccessors")), o = "" + b)
              } else o = t.static ? "" + a : a + ".prototype";
              t.computed || (o += "."), (c > 0 && r === c + 1 || 0 === r && c === n.body.length - 1) && (o = "\n\n" + p + o);
              var d = t.key.end;
              if (t.computed) if (u) e.prependRight(t.key.start, "["), e.appendLeft(t.key.end, "]"); else {
                for (; "]" !== e.original[d];) d += 1;
                d += 1
              }
              var f = t.computed || h || !y ? "" : l + " ",
                m = (h ? "." + t.kind : "") + " = function" + (t.value.generator ? "* " : " ") + f;
              e.remove(d, t.value.start), e.prependRight(t.value.start, m), e.appendLeft(t.end, ";"), t.value.generator && e.remove(t.start, t.key.start), e.prependRight(t.start, o)
            } else {
              var v = g ? " " + a : "";
            ...
            var E = [], A = [];
            S.length && (E.push("var " + b + " = { " + S.map((function (t) {
              return t + ": { configurable: true }"
            })).join(",") + " };"), A.push("Object.defineProperties( " + a + ".prototype, " + b + " );")), w.length && (E.push("var " + _ + " = { " + w.map((function (t) {
              return t + ": { configurable: true }"
            })).join(",") + " };"), A.push("Object.defineProperties( " + a + ", " + _ + " );")), l && (u += "\n\n" + p), u += E.join("\n" + p), l || (u += "\n\n" + p), d += "\n\n" + p + A.join("\n" + p)
          }
    ...
    var Ee = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        ...
        if (e.classes) {
          this.superClass || function (t, e) {
            var i = t.start, r = t.end, s = e.getIndentString(), n = s.length, a = i - n;
            t.program.indentExclusions[a] || e.original.slice(a, i) !== s || e.remove(a, i);
            for (var o, p = new RegExp(s + "\\S", "g"), h = e.original.slice(i, r); o = p.exec(h);) {
              var c = i + o.index;
              t.program.indentExclusions[c] || e.remove(c, c + n)
            }
          }(this.body, t);
          var i = this.superClass && (this.superClass.name || "superclass"), r = this.getIndentation(),
            s = r + t.getIndentString(), n = "ExportDefaultDeclaration" === this.parent.type;
          n && t.remove(this.parent.start, this.start);
          var a = this.start;
          this.id ? (t.overwrite(a, this.id.start, "var "), a = this.id.end) : t.prependLeft(a, "var " + this.name), this.superClass ? this.superClass.end === this.body.start ? (t.remove(a, this.superClass.start), t.appendLeft(a, " = /*@__PURE__*/(function (" + i + ") {\n" + s)) : (t.overwrite(a, this.superClass.start, " = "), t.overwrite(this.superClass.end, this.body.start, "/*@__PURE__*/(function (" + i + ") {\n" + s)) : a === this.body.start ? t.appendLeft(a, " = ") : t.overwrite(a, this.body.start, " = "), this.body.transpile(t, e, !!this.superClass, i);
          var o = n ? "\n\n" + r + "export default " + this.name + ";" : "";
          this.superClass ? (t.appendLeft(this.end, "\n\n" + s + "return " + this.name + ";\n" + r + "}("), t.move(this.superClass.start, this.superClass.end, this.end), t.prependRight(this.end, "));" + o)) : o && t.prependRight(this.end, o)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (t) {
        if (this.findNearest(_e).shouldRewriteAsFunction) {
          if (this.label) throw new ne("Labels are not currently supported in a loop with locally-scoped variables", this);
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.moduleExport) throw new ne("export is not supported", this);
        t.prototype.initialise.call(this, e)
      }, e
    }($t), Le = function (t) {
      function e() {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.findScope = function (t) {
        return t || !this.createdScope ? this.parent.findScope(t) : this.body.scope
      }, e.prototype.initialise = function (e) {
        var i = this;
        if (this.body.createScope(), this.createdScope = !0, this.reassigned = Object.create(null), this.aliases = Object.create(null), this.thisRefs = [], t.prototype.initialise.call(this, e), e.letConst) for (var r = Object.keys(this.body.scope.declarations), s = r.length; s--;) {
          for (var n = r[s], a = i.body.scope.declarations[n], o = a.instances.length; o--;) {
            var p = a.instances[o].findNearest(/Function/);
            if (p && p.depth > i.depth) {
              i.shouldRewriteAsFunction = !0;
              for (var h = 0, c = i.thisRefs; h < c.length; h += 1) {
                var l = c[h];
                l.alias = l.alias || l.findLexicalBoundary().getThisAlias()
              }
              break
            }
          }
          if (i.shouldRewriteAsFunction) break
        }
      }, e.prototype.transpile = function (e, i) {
        var r = "ForOfStatement" != this.type && ("BlockStatement" !== this.body.type || "BlockStatement" === this.body.type && this.body.synthetic);
        if (this.shouldRewriteAsFunction) {
          var s = this.getIndentation(), n = s + e.getIndentString(),
            a = this.args ? " " + this.args.join(", ") + " " : "",
            o = this.params ? " " + this.params.join(", ") + " " : "", p = this.findScope(!0),
          ...
          if (e.prependRight(this.body.start, c), e.appendLeft(this.body.end, l), e.move(this.start, this.body.start, this.body.end), this.canBreak || this.canReturn) {
            var u = p.createIdentifier("returned"), d = "{\n" + n + "var " + u + " = " + h + "(" + a + ");\n";
            this.canBreak && (d += "\n" + n + "if ( " + u + " === 'break' ) break;"), this.canReturn && (d += "\n" + n + "if ( " + u + " ) return " + u + ".v;"), d += "\n" + s + "}", e.prependRight(this.body.end, d)
          } else {
            var f = h + "(" + a + ");";
            "DoWhileStatement" === this.type ? e.overwrite(this.start, this.body.start, "do {\n" + n + f + "\n" + s + "}") : e.prependRight(this.body.end, f)
          }
        } else r && (e.appendLeft(this.body.start, "{ "), e.prependRight(this.body.end, " }"));
        t.prototype.transpile.call(this, e, i)
      }, e
    }($t), Ne = function (t) {
      function e() {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.findScope = function (t) {
        ...
        var r = this, s = this.getIndentation() + e.getIndentString();
        if (this.shouldRewriteAsFunction) {
          ...
          if (o.length) if (this.body.synthetic) e.appendLeft(this.body.body[0].end, "; " + o.join(" ")); else {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.findScope = function (t) {
        ...
        var r = this, s = "VariableDeclaration" === this.left.type;
        if (this.shouldRewriteAsFunction) {
          var n = s ? this.left.declarations.map((function (t) {
            return Yt(t.id)
          })) : [];
          this.args = n.map((function (t) {
            return t in r.aliases ? r.aliases[t].outer : t
        ...
        t.prototype.transpile.call(this, e, i);
        var a = s ? this.left.declarations[0].id : this.left;
        "Identifier" !== a.type && this.destructurePattern(e, a, s)
      }, e.prototype.destructurePattern = function (t, e, i) {
        var r = this.findScope(!0), s = this.getIndentation() + t.getIndentString(), n = r.createIdentifier("ref"),
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.forOf && !e.dangerousForOf) throw new ne("for...of statements are not supported. Use `transforms: { forOf: false }` to skip transformation and disable this error, or `transforms: { dangerousForOf: true }` if you know what you're doing", this);
        t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        if (t.prototype.transpile.call(this, e, i), i.dangerousForOf) if (this.body.body[0]) {
          var r = this.findScope(!0), s = this.getIndentation(), n = s + e.getIndentString(),
            a = r.createIdentifier("i"), o = r.createIdentifier("list");
          ...
          var h = "VariableDeclaration" === this.left.type, c = h ? this.left.declarations[0].id : this.left;
          if ("Identifier" !== c.type) {
            var l = [], u = r.createIdentifier("ref");
            pe(e, (function (t) {
              return r.createIdentifier(t)
            }), (function (t) {
              var e = t.name;
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (this.generator && e.generator) throw new ne("Generators are not supported", this);
        this.body.createScope(), this.id && this.findScope(!0).addDeclaration(this.id, "function"), t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        t.prototype.transpile.call(this, e, i), i.trailingFunctionCommas && this.params.length && ye(e, this.params[this.params.length - 1].end)
      }, e
    }($t), je = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (this.generator && e.generator) throw new ne("Generators are not supported", this);
        this.body.createScope(), this.id && this.body.scope.addDeclaration(this.id, "function"), t.prototype.initialise.call(this, e);
        var i, r = this.parent;
        if (e.conciseMethodProperty && "Property" === r.type && "init" === r.kind && r.method && "Identifier" === r.key.type || e.classes && "MethodDefinition" === r.type && "method" === r.kind && "Identifier" === r.key.type ? i = r.key.name : this.id && "Identifier" === this.id.type && (i = this.id.alias || this.id.name), i) for (var s = 0, n = this.params; s < n.length; s += 1) {
          var a = n[s];
          if ("Identifier" === a.type && i === a.name) {
            var o = this.body.scope, p = o.declarations[i], h = o.createIdentifier(i);
            a.alias = h;
    ...
    function Ve(t, e) {
      return "MemberExpression" === t.type ? !t.computed && Ve(t.object, t) : "Identifier" === t.type ? !e || !/(Function|Class)Expression/.test(e.type) && ("VariableDeclarator" === e.type ? t === e.init : "MemberExpression" === e.type || "MethodDefinition" === e.type ? e.computed || t === e.object : "ArrayPattern" !== e.type && ("Property" === e.type ? "ObjectPattern" !== e.parent.type && (e.computed || t === e.value) : "MethodDefinition" !== e.type && ("ExportSpecifier" !== e.type || t === e.local))) : void 0
    }
    ...
    var De = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.findScope = function (t) {
        return this.parent.params && ~this.parent.params.indexOf(this) || "FunctionExpression" === this.parent.type && this === this.parent.id ? this.parent.body.scope : this.parent.findScope(t)
      }, e.prototype.initialise = function (t) {
        if (Ve(this, this.parent)) {
          if (t.arrow && "arguments" === this.name && !this.findScope(!1).contains(this.name)) {
            var e = this.findLexicalBoundary(), i = this.findNearest("ArrowFunctionExpression"),
              r = this.findNearest(_e);
            i && i.depth > e.depth && (this.alias = e.getArgumentsAlias()), r && r.body.contains(this) && r.depth > e.depth && (this.alias = e.getArgumentsAlias())
          }
          this.findScope(!1).addReference(this)
        }
      }, e.prototype.transpile = function (t) {
        this.alias && t.overwrite(this.start, this.end, this.alias, {storeName: !0, contentOnly: !0})
      }, e
    }($t), Fe = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.moduleImport) throw new ne("import is not supported", this);
        t.prototype.initialise.call(this, e)
      }, e
    }($t), Me = function (t) {
      function e() {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
        var r, s = this.name, n = s.start, a = s.name, o = this.value ? this.value.start : this.name.end;
        e.overwrite(n, o, (/-/.test(r = a) ? "'" + r + "'" : r) + ": " + (this.value ? "" : "true")), t.prototype.transpile.call(this, e, i)
      }, e
    }($t);
    var Xe = function (t) {
      function e() {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (t) {
        var e, i = !0, r = this.parent.children[this.parent.children.length - 1];
        (r && ("JSXText" === (e = r).type && !/\S/.test(e.value) && /\n/.test(e.value)) || this.parent.openingElement.attributes.length) && (i = !1), t.overwrite(this.start, this.end, i ? " )" : ")")
      }, e
    }($t);
    var Je = function (t) {
      function e() {
    ...
    var He = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
        ...
        if (r.length) {
          var s, n = (this.openingElement || this.openingFragment).end;
          for (s = 0; s < r.length; s += 1) {
            var a = r[s];
            if ("JSXExpressionContainer" === a.type && "JSXEmptyExpression" === a.expression.type) ; else {
              var o = "\n" === e.original[n] && "JSXText" !== a.type ? "" : " ";
              e.appendLeft(n, "," + o)
            }
            if ("JSXText" === a.type) {
              var p = We(a.value, s === r.length - 1);
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
        ...
        var n = this.attributes.length, a = this.name.end;
        if (n) {
          var o, p, h, c = !1;
          for (o = 0; o < n; o += 1) if ("JSXSpreadAttribute" === r.attributes[o].type) {
            c = !0;
            break
          }
          for (a = this.attributes[0].end, o = 0; o < n; o += 1) {
            var l = r.attributes[o];
            if (o > 0 && (l.start === a ? e.prependRight(a, ", ") : e.overwrite(a, l.start, ", ")), c && "JSXSpreadAttribute" !== l.type) {
              var u = r.attributes[o - 1], d = r.attributes[o + 1];
              u && "JSXSpreadAttribute" !== u.type || e.prependRight(l.start, "{ "), d && "JSXSpreadAttribute" !== d.type || e.appendLeft(l.end, " }")
            }
            a = l.end
          }
          if (c) if (1 === n) h = s ? "'," : ","; else {
            if (!this.program.options.objectAssign) throw new ne("Mixed JSX attributes ending in spread requires specified objectAssign option with 'Object.assign' or polyfill helper.", this);
            h = s ? "', " + this.program.options.objectAssign + "({}," : ", " + this.program.options.objectAssign + "({},", p = ")"
          } else h = s ? "', {" : ", {", p = " }";
          e.prependRight(this.name.end, h), p && e.appendLeft(this.attributes[n - 1].end, p)
        } else e.appendLeft(this.name.end, s ? "', null" : ", null"), a = this.name.end;
        this.selfClosing ? e.overwrite(a, this.end, this.attributes.length ? ")" : " )") : e.remove(a, this.end)
      }, e
    }($t), Ke = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function () {
        ...
        if (e.numericLiteral && this.raw.match(/^0[bo]/i) && t.overwrite(this.start, this.end, String(this.value), {
          storeName: !0,
          contentOnly: !0
        }), this.regex) {
          var i = this.regex, r = i.pattern, n = i.flags;
          if (e.stickyRegExp && /y/.test(n)) throw new ne("Regular expression sticky flag is not supported", this);
          e.unicodeRegExp && /u/.test(n) && t.overwrite(this.start, this.end, "/" + s()(r, n) + "/" + n.replace("u", ""), {contentOnly: !0})
        } else "string" == typeof this.value && this.value.match(Ye) && t.overwrite(this.start, this.end, this.raw.replace(Ye, (function (t) {
          return "\u2028" == t ? "\\u2028" : "\\u2029"
        })), {contentOnly: !0})
      }, e
    }($t), ti = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
        i.reservedProperties && te[this.property.name] && (e.overwrite(this.object.end, this.property.start, "['"), e.appendLeft(this.property.end, "']")), t.prototype.transpile.call(this, e, i)
      }, e
    }($t), ei = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.spreadRest && this.arguments.length) for (var i = this.findLexicalBoundary(), r = this.arguments.length; r--;) {
          var s = this.arguments[r];
          if ("SpreadElement" === s.type && de(s.argument)) {
        ...
        if (t.prototype.transpile.call(this, e, i), i.spreadRest && this.arguments.length) {
          var r = this.arguments[0];
          fe(e, this.arguments, r.start, this.argumentsArrayAlias, !0) && (e.prependRight(this.start + "new".length, " (Function.prototype.bind.apply("), e.overwrite(this.callee.end, r.start, ", [ null ].concat( "), e.appendLeft(this.end, " ))"))
        }
        this.arguments.length && ye(e, this.arguments[this.arguments.length - 1].end)
      }, e
    }($t), ii = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
        var r = this;
        t.prototype.transpile.call(this, e, i);
        for (var s = this.start + 1, n = 0, a = 0, o = null, p = null, h = 0; h < this.properties.length; ++h) {
          var c = r.properties[h];
          "SpreadElement" === c.type ? (n += 1, null === o && (o = h)) : c.computed && i.computedProperty && (a += 1, null === p && (p = h))
        }
        if (!n || i.objectRestSpread || a && i.computedProperty) {
          if (n) {
            if (!this.program.options.objectAssign) throw new ne("Object spread operator requires specified objectAssign option with 'Object.assign' or polyfill helper.", this);
            for (var l = this.properties.length; l--;) {
              var u = r.properties[l];
              if ("Property" === u.type && !a) {
                var d = r.properties[l - 1], f = r.properties[l + 1];
                d && "Property" === d.type || e.prependRight(u.start, "{"), f && "Property" === f.type || e.appendLeft(u.end, "}")
              }
              "SpreadElement" === u.type && (e.remove(u.start, u.argument.start), e.remove(u.argument.end, u.end))
            }
            s = this.properties[0].start, a ? "SpreadElement" === this.properties[0].type ? (e.overwrite(this.start, s, this.program.options.objectAssign + "({}, "), e.remove(this.end - 1, this.end), e.appendRight(this.end, ")")) : (e.prependLeft(this.start, this.program.options.objectAssign + "("), e.appendRight(this.end, ")")) : (e.overwrite(this.start, s, this.program.options.objectAssign + "({}, "), e.overwrite(this.properties[this.properties.length - 1].end, this.end, ")"))
          }
        } else n = 0, o = null;
        if (a && i.computedProperty) {
          var m, y, g = this.getIndentation();
          "VariableDeclarator" === this.parent.type && 1 === this.parent.parent.declarations.length && "Identifier" === this.parent.id.type ? (m = !0, y = this.parent.id.alias || this.parent.id.name) : ("AssignmentExpression" === this.parent.type && "ExpressionStatement" === this.parent.parent.type && "Identifier" === this.parent.left.type || "AssignmentPattern" === this.parent.type && "Identifier" === this.parent.left.type) && (m = !0, y = this.parent.left.alias || this.parent.left.name), n && (m = !1), y = this.findScope(!1).resolveName(y);
          var v = s, x = this.end;
          m || (null === o || p < o ? (y = this.findScope(!0).createDeclaration("obj"), e.prependRight(this.start, "( " + y + " = ")) : y = null);
          for (var b, _ = this.properties.length, k = !1, S = !0, w = 0; w < _; w += 1) {
            var E = r.properties[w], A = w > 0 ? r.properties[w - 1].end : v;
            if ("Property" === E.type && (E.computed || b && !n)) {
              if (0 === w && (A = r.start + 1), b = E, y) {
                var C = (m ? ";\n" + g + y : ", " + y) + ("Literal" === E.key.type || E.computed ? "" : ".");
                A < E.start ? e.overwrite(A, E.start, C) : e.prependRight(E.start, C)
              } else {
                var I = (y = r.findScope(!0).createDeclaration("obj")) + (E.computed ? "" : ".");
                e.appendRight(E.start, "( " + y + " = {}, " + I)
              }
              var L = E.key.end;
              if (E.computed) {
              ...
              "Literal" !== E.key.type || E.computed ? E.shorthand || E.method && !E.computed && i.conciseMethodProperty ? e.overwrite(E.key.start, E.key.end, e.slice(E.key.start, E.key.end).replace(/:/, " =")) : (E.value.start > L && e.remove(L, E.value.start), e.prependLeft(L, " = ")) : e.overwrite(E.start, E.key.end + 1, "[" + e.slice(E.start, E.key.end) + "] = "), !E.method || !E.computed && i.conciseMethodProperty || (E.value.generator && e.remove(E.start, E.key.start), e.prependRight(E.value.start, "function" + (E.value.generator ? "*" : "") + " "))
            } else "SpreadElement" === E.type ? y && w > 0 && (b || (b = r.properties[w - 1]), e.appendLeft(b.end, ", " + y + " )"), b = null, y = null) : (!S && n && (e.prependRight(E.start, "{"), e.appendLeft(E.end, "}")), k = !0);
            if (S && ("SpreadElement" === E.type || E.computed)) {
              var P = k ? r.properties[r.properties.length - 1].end : r.end - 1;
              "," == e.original[P] && ++P;
              var N = e.slice(P, x);
              e.prependLeft(A, N), e.remove(P, x), S = !1
            }
            var T = E.end;
            if (w < _ - 1 && !k) for (; "," !== e.original[T];) T += 1; else w == _ - 1 && (T = r.end);
            E.end != T && e.overwrite(E.end, T, "", {contentOnly: !0})
          }
          !m && y && e.appendLeft(b.end, ", " + y + " )")
        }
      }, e
    }($t), ri = function (t) {
      function e() {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (("get" === this.kind || "set" === this.kind) && e.getterSetter) throw new ne("getters and setters are not supported. Use `transforms: { getterSetter: false }` to skip transformation and disable this error", this);
        t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        ...
        i.reservedProperties && te[this.key.name] && (e.prependRight(this.key.start, "'"), e.appendLeft(this.key.end, "'"))
      }, e
    }($t), si = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (t) {
        this.loop = this.findNearest(_e), this.nearestFunction = this.findNearest(/Function/), this.loop && (!this.nearestFunction || this.loop.depth > this.nearestFunction.depth) && (this.loop.canReturn = !0, this.shouldWrap = !0), this.argument && this.argument.initialise(t)
      }, e.prototype.transpile = function (t, e) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (t) {
        if (t.classes) {
          if (this.method = this.findNearest("MethodDefinition"), !this.method) throw new ne("use of super outside class method", this);
          var e = this.findNearest("ClassBody").parent;
          if (this.superClassName = e.superClass && (e.superClass.name || "superclass"), !this.superClassName) throw new ne("super used in base class", this);
          if (this.isCalled = "CallExpression" === this.parent.type && this === this.parent.callee, "constructor" !== this.method.kind && this.isCalled) throw new ne("super() not allowed outside class constructor", this);
          if (this.isMember = "MemberExpression" === this.parent.type, !this.isCalled && !this.isMember) throw new ne("Unexpected use of `super` (expected `super(...)` or `super.*`)", this)
        }
        if (t.arrow) {
          var i = this.findLexicalBoundary(), r = this.findNearest("ArrowFunctionExpression"), s = this.findNearest(_e);
          r && r.depth > i.depth && (this.thisAlias = i.getThisAlias()), s && s.body.contains(this) && s.depth > i.depth && (this.thisAlias = i.getThisAlias())
        }
      }, e.prototype.transpile = function (t, e) {
        if (e.classes) {
          var i = this.isCalled || this.method.static ? this.superClassName : this.superClassName + ".prototype";
          t.overwrite(this.start, this.end, i, {storeName: !0, contentOnly: !0});
          ...
          if (r && "CallExpression" === r.type) {
            ...
            r.arguments.length ? t.appendLeft(r.arguments[0].start, s + ", ") : t.appendLeft(r.end - 1, "" + s)
          }
        }
      }, e
    }($t), ai = function (t) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if (e.templateString && !e.dangerousTaggedTemplateString) throw new ne("Tagged template strings are not supported. Use `transforms: { templateString: false }` to skip transformation and disable this error, or `transforms: { dangerousTaggedTemplateString: true }` if you know what you're doing", this);
        t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        if (i.templateString && i.dangerousTaggedTemplateString) {
          var r = this.quasi.expressions.concat(this.quasi.quasis).sort((function (t, e) {
            return t.start - e.start
          })), s = this.program.body.scope, n = this.quasi.quasis.map((function (t) {
            return JSON.stringify(t.value.cooked)
          })).join(", "), a = this.program.templateLiteralQuasis[n];
          a || (a = s.createIdentifier("templateObject"), e.prependRight(this.program.prependAt, "var " + a + " = Object.freeze([" + n + "]);\n"), this.program.templateLiteralQuasis[n] = a), e.overwrite(this.tag.end, r[0].start, "(" + a);
          var o = r[0].start;
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.transpile = function (e, i) {
        if (t.prototype.transpile.call(this, e, i), i.templateString && "TaggedTemplateExpression" !== this.parent.type) {
          var r = this.expressions.concat(this.quasis).sort((function (t, e) {
          ...
          if (r.length >= 3) {
            var s = r[0], n = r[2];
            "TemplateElement" === s.type && "" === s.value.raw && "TemplateElement" === n.type && r.shift()
          }
          var a = !(1 === this.quasis.length && 0 === this.expressions.length || "TemplateLiteral" === this.parent.type || "AssignmentExpression" === this.parent.type || "AssignmentPattern" === this.parent.type || "VariableDeclarator" === this.parent.type || "BinaryExpression" === this.parent.type && "+" === this.parent.operator);
          a && e.appendRight(this.start, "(");
          var o = this.start;
          r.forEach((function (t, i) {
            var r = 0 === i ? a ? "(" : "" : " + ";
            if ("TemplateElement" === t.type) e.overwrite(o, t.end, r + JSON.stringify(t.value.cooked)); else {
              var s = "Identifier" !== t.type;
              s && (r += "("), e.remove(o, t.start), r && e.prependRight(t.start, r), s && e.appendLeft(t.end, ")")
            }
            o = t.end
          })), a && e.appendLeft(o, ")"), e.overwrite(o, this.end, "", {contentOnly: !0})
        }
      }, e
    }($t), hi = function (t) {
      function e() {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (t) {
        ...
        if (t.letConst) for (var i = this.findNearest(_e); i && i.depth > e.depth;) i.thisRefs.push(this), i = i.parent.findNearest(_e);
        if (t.arrow) {
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (e) {
        if ("Identifier" === this.argument.type) {
          var i = this.findScope(!1).findDeclaration(this.argument.name), r = i && i.node.ancestor(3);
          r && "ForStatement" === r.type && r.body.contains(this) && (r.reassigned[this.argument.name] = !0)
        }
        t.prototype.initialise.call(this, e)
      }, e.prototype.transpile = function (e, i) {
        "Identifier" === this.argument.type && ve(this.argument, this.findScope(!1)), t.prototype.transpile.call(this, e, i)
      }, e
    }($t), li = function (t) {
      function e() {
        t.apply(this, arguments)
      ...
      return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.initialise = function (t) {
        ...
        var i = this, r = this.getIndentation(), s = this.kind;
        if (e.letConst && "var" !== s && (s = "var", t.overwrite(this.start, this.start + this.kind.length, s, {
          contentOnly: !0,
          storeName: !0
        })), e.destructuring && "ForOfStatement" !== this.parent.type && "ForInStatement" !== this.parent.type) {
          var n, a = this.start;
          this.declarations.forEach((function (s, o) {
            if (s.transpile(t, e), "Identifier" === s.id.type) o > 0 && "Identifier" !== i.declarations[o - 1].id.type && t.overwrite(a, s.id.start, "var "); else {
              var p = _e.test(i.parent.type);
              0 === o ? t.remove(a, s.id.start) : t.overwrite(a, s.id.start, ";\n" + r);
              var h = "Identifier" === s.init.type && !s.init.rewritten,
                c = h ? s.init.alias || s.init.name : s.findScope(!0).createIdentifier("ref");
              a = s.start;
              var l = [];
              h ? t.remove(s.id.end, s.end) : l.push((function (e, i, r) {
                t.prependRight(s.id.end, "var " + c), t.appendLeft(s.init.end, "" + r), t.move(s.id.end, s.end, e)
              }));
              var u = s.findScope(!1);
              pe(t, (function (t) {
              ...
              var d = p ? "var " : "", f = p ? ", " : ";\n" + r;
              l.forEach((function (t, e) {
                o === i.declarations.length - 1 && e === l.length - 1 && (f = p ? "" : ";"), t(s.start, 0 === e ? d : "", f)
              }))
            }
            a = s.end, n = "Identifier" !== s.id.type
          })), n && this.end > a && t.overwrite(a, this.end, "", {contentOnly: !0})
      ...
      ClassDeclaration: Ee,
      ClassExpression: Ae,
      ContinueStatement: Ce,
      DoWhileStatement: Pe,
      ExportNamedDeclaration: Le,
      ExportDefaultDeclaration: Ie,
      ForStatement: Ne,
      ForInStatement: Te,
      ForOfStatement: Re,
      FunctionDeclaration: Oe,
      FunctionExpression: je,
      Identifier: De,
      IfStatement: Fe,
      ImportDeclaration: Be,
      ImportDefaultSpecifier: Me,
      ImportSpecifier: Ue,
      JSXAttribute: qe,
      JSXClosingElement: Xe,
      JSXClosingFragment: Je,
      JSXElement: He,
      JSXExpressionContainer: ze,
      JSXFragment: Ge,
      JSXOpeningElement: Qe,
      JSXOpeningFragment: Ke,
      JSXSpreadAttribute: $e,
      Literal: Ze,
      MemberExpression: ti,
      NewExpression: ei,
      ObjectExpression: ii,
      ...
      ReturnStatement: si,
      Super: ni,
      TaggedTemplateExpression: ai,
      TemplateElement: oi,
      TemplateLiteral: pi,
      ThisExpression: hi,
      UpdateExpression: ci,
      VariableDeclaration: li,
      VariableDeclarator: ui,
      WhileStatement: Pe
    }, fi = {Program: ["body"], Literal: []}, mi = {
    ...
    function yi(t, e) {
      if (t) if ("length" in t) for (var i = t.length; i--;) yi(t[i], e); else if (!t.__wrapped) {
        t.__wrapped = !0, fi[t.type] || (fi[t.type] = Object.keys(t).filter((function (e) {
          return "object" == typeof t[e]
        })));
        var r = mi[t.type];
        if (r && "BlockStatement" !== t[r].type) {
          var s = t[r];
          t[r] = {start: s.start, end: s.end, type: "BlockStatement", body: [s], synthetic: !0}
        }
        t.parent = e, t.program = e.program || e, t.depth = e.depth + 1, t.keys = fi[t.type], t.indentation = void 0;
        for (var n = 0, a = fi[t.type]; n < a.length; n += 1) {
          var o = a[n];
          yi(t[o], t)
        }
        t.program.magicString.addSourcemapLocation(t.start), t.program.magicString.addSourcemapLocation(t.end);
        var p = ("BlockStatement" === t.type ? ue : di[t.type]) || $t;
    ...
    function gi(t, e, i, r) {
      var s = this;
      this.type = "Root", this.jsx = r.jsx || "React.createElement", this.options = r, this.source = t, this.magicString = new n.ZP(t), this.ast = e, this.depth = 0, yi(this.body = e, this), this.body.__proto__ = ue.prototype, this.templateLiteralQuasis = Object.create(null);
      for (var a = 0; a < this.body.body.length; ++a) if (!s.body.body[a].directive) {
        s.prependAt = s.body.body[a].start;
        break
      }
      ...
      for (var o = 0, p = s.indentExclusionElements; o < p.length; o += 1) for (var h = p[o], c = h.start; c < h.end; c += 1) s.indentExclusions[c] = !0;
    ...
    gi.prototype = {
      export: function (t) {
        return void 0 === t && (t = {}), {
          ...
          map: this.magicString.generateMap({file: t.file, source: t.source, includeContent: !1 !== t.includeContent})
        }
    ...
    var vi = {
        ...
        safari: {8: 524297, 9: 594141, 10: 1831935, 10.1: 4191231, 11: 4191231, 11.1: 8385535, 12: 8385535},
        ie: {8: 0, 9: 524289, 10: 524289, 11: 524289},
        edge: {12: 610459, 13: 774559, 14: 2085887, 15: 4183039, 16: 4183039, 17: 4183039, 18: 4183039, 19: 4183039},
        node: {
          "0.10": 524289,
          .12: 524417,
          4: 594335,
      ...
      xi = ["getterSetter", "arrow", "classes", "computedProperty", "conciseMethodProperty", "defaultParameter", "destructuring", "forOf", "generator", "letConst", "moduleExport", "moduleImport", "numericLiteral", "parameterDestructuring", "spreadRest", "stickyRegExp", "templateString", "unicodeRegExp", "exponentiation", "reservedProperties", "trailingFunctionCommas", "asyncAwait", "objectRestSpread"],
      bi = X.extend(Qt, Jt()), _i = ["dangerousTaggedTemplateString", "dangerousForOf"];
    ...
    function ki(t, e) {
      ...
      try {
        ...
        throw n.snippet = se(t, n.loc), n.toString = function () {
      ...
      var s = function (t) {
        ...
        Object.keys(t).forEach((function (i) {
          var r = vi[i];
          if (!r) throw new Error("Unknown environment '" + i + "'. Please raise an issue at https://github.com/Rich-Harris/buble/issues");
          var s = t[i];
          if (!(s in r)) throw new Error("Support data exists for the following versions of " + i + ": " + Object.keys(r).join(", ") + ". Please raise an issue at https://github.com/Rich-Harris/buble/issues");
          var n = r[s];
          e &= n
        }));
        var i = Object.create(null);
        return xi.forEach((function (t, r) {
          i[t] = !(e & 1 << r)
        })), _i.forEach((function (t) {
          i[t] = !1
        })), i
      }(e.target || {});
      return Object.keys(e.transforms || {}).forEach((function (t) {
        if ("modules" === t) return "moduleImport" in e.transforms || (s.moduleImport = e.transforms.modules), void ("moduleExport" in e.transforms || (s.moduleExport = e.transforms.modules));
        if (!(t in s)) throw new Error("Unknown transform '" + t + "'");
        s[t] = e.transforms[t]
      })), !0 === e.objectAssign && (e.objectAssign = "Object.assign"), new gi(t, i, s, e).export(e)
    }
  }
}]);
//# sourceMappingURL=bac1b955-ba302de2601a17e7f387.js.map
